...
class Question_bank extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['groups']  = pluck($this->question_group_m->get_order_by_question_group(array('schoolID' => $schoolID)), 'obj', 'questionGroupID');
        ...
        $this->data['question_banks'] = $this->question_bank_m->get_order_by_question_bank(array('schoolID' => $schoolID));
    ...
    public function photoupload() {
        ...
        $question_bank = array();
        if((int)$id) {
            $question_bank = $this->question_bank_m->get_question_bank(array('questionBankID' => $id, 'schoolID' => $schoolID));
        }
    ...
    public function add() {
        ...
        $this->data['types']   = $this->question_type_m->get_order_by_question_type(array('schoolID' => $schoolID));
    ...
    public function edit() {
        ...
        if((int)$questionID) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['question_bank'] = $this->question_bank_m->get_single_question_bank(array('questionBankID' => $questionID, 'schoolID' => $schoolID));
    ...
    public function view() {
        ...
        $questionID = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$questionID) {
            $questionBank = $this->question_bank_m->get_single_question_bank(array('questionBankID' => $questionID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['question_bank'] = $this->question_bank_m->get_single_question_bank(array('questionBankID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function print_preview() {
        if(permissionChecker('question_bank_view')) {
            $id = htmlentities(escapeString($this->uri->segment(3)));
            if((int)$id) {
                $questionBank = $this->question_bank_m->get_single_question_bank(array('questionBankID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
                $this->data['question'] =  $questionBank;
                if(customCompute($questionBank)) {
                    $allOptions = $this->question_option_m->get_order_by_question_option(array('questionID'=>$questionBank->questionBankID));
                    $options = [];
    ...
    public function valid_answer() {
        ...
        if($type != 3) {
            ...
            $optionsDB  = [];
            if((int)$questionID) {
                $optionsDB  = $this->question_option_m->get_order_by_question_option(['questionID' => $questionID, 'schoolID' => $this->session->userdata('schoolID')]);
            }
