...
class Paymentsettings extends Admin_Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        $gatewayOptions                        = $this->payment_gateway_option_m->get_payment_gateway_option_values(array("schoolID" => $schoolID));
                ...
                if($this->form_validation->run() == false) {
                    ...
                    for($i = 0; $i < customCompute($rules); $i++) {
                        ...
                        if($gateway_options[$key]) {
                            $array[$j]['payment_gateway_option_id']                 = $gateway_options[$key]->id;
