...
*/
    ...
    public function getStudent() {
        ...
        $queryArray = array('srschoolyearID' => $this->session->userdata('defaultschoolyearID'), 'srschoolID' => $this->session->userdata('schoolID'));
    ...
    private function queryArray($posts) {
        ...
        $queryArray = [];
        $queryArray = array('srschoolyearID' => $this->session->userdata('defaultschoolyearID'), 'srclassesID' => $classesID, 'srschoolID' => $this->session->userdata('schoolID'));
        if((int)$sectionID > 0) {
            $queryArray['srsectionID'] = $sectionID;
        }
        if((int)$studentID > 0) {
        ...
        if(permissionChecker('librarycardreport')) {
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $this->data['schoolyear']  = $this->schoolyear_m->get_single_schoolyear(array('schoolyearID'=>$schoolyearID,'schoolID'=>$schoolID));
