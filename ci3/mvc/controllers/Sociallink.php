...
class Sociallink extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        if((int)$id) {
            $sociallinks = $this->sociallink_m->get_order_by_sociallink(array('usertypeID' => $id, 'schoolID' => $schoolID));
        } else {
            $sociallinks = $this->sociallink_m->get_order_by_sociallink(array('schoolID' => $schoolID));
        }
    ...
    private function userListName($sociallinks) {
        ...
        $schoolID = $this->session->userdata('schoolID');
        $systemadmin = $this->systemadmin_m->get_order_by_systemadmin(array('schoolID' => $schoolID));
        if(customCompute($systemadmin)) {
            $returnArray[1]= pluck($systemadmin, 'obj', 'systemadminID');
        }

        $teacher = $this->teacher_m->get_order_by_teacher(array('schoolID' => $schoolID));
        ...
        $parent = $this->parents_m->get_order_by_parents(array('schoolID' => $schoolID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['sociallink'] = $this->sociallink_m->get_single_sociallink(array('sociallinkID' => $id, 'schoolID' => $schoolID));
    ...
    public function delete() {
        ...
        if((int)$id) {
            ...
            $this->data['sociallink'] = $this->sociallink_m->get_single_sociallink(array('sociallinkID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['sociallink']) {
    ...
    private function getUserData($userroleID) {
        ...
        if((int)$userroleID) {
            $schoolID = $this->session->userdata('schoolID');
            $sociallink = pluck($this->sociallink_m->get_order_by_sociallink(array('usertypeID' => $userroleID, 'schoolID' => $schoolID)), 'obj', 'userID');
            ...
            if($userroleID == 1) {
                ...
                $students = $this->student_m->get_order_by_student(array('schoolID' => $schoolID));
                ...
                $users = $this->user_m->get_order_by_user(array('usertypeID' => $userroleID, 'schoolID' => $schoolID));
                if(customCompute($users)) {
                    foreach ($users as $user) {
    ...
    public function unique_user() {
        ...
        if($userID == "0") {
            ...
            $schoolID = $this->session->userdata('schoolID');
            if((int)$id) {
                $result = $this->sociallink_m->get_order_by_sociallink(array('usertypeID'=>$userroleID,'userID'=>$userID,'sociallinkID !='=>$id,'schoolID'=>$schoolID));
                return TRUE;
            } else {
                $result = $this->sociallink_m->get_order_by_sociallink(array('usertypeID'=>$userroleID,'userID'=>$userID,'schoolID'=>$schoolID));
