...
*/
	...
	public function index() {
		...
		$classes = pluck($this->classes_m->get_order_by_classes(array('schoolID' => $schoolID)),'classesID','classesID');
		$ebooks = $this->ebooks_m->get_order_by_ebooks_with_authority($classes, $schoolID);
    ...
    $this->pagination->initialize($config);
		$this->data['ebooks'] = $this->ebooks_m->get_order_by_ebooks_with_authority_pagination($classes, $schoolID, $config['per_page'], $this->uri->segment('3'));
	...
	public function edit() {
		...
		if((int)$ebooksID) {
			...
			$this->data['ebooks'] = $this->ebooks_m->get_single_ebooks_with_authority($classesArray, $ebooksID, $schoolID);
	...
	public function delete() {
		...
		if((int)$ebooksID) {
			...
			$classes = $this->classes_m->get_order_by_classes(array('schoolID' => $schoolID));
			$classesArray = pluck($classes, 'classesID','classesID');
			$ebooks = $this->ebooks_m->get_single_ebooks_with_authority($classesArray, $ebooksID, $schoolID);
