...
*/
	...
	public function index() {
		...
		$this->data['online_exams'] = $this->online_exam_m->get_order_by_online_exam(array('published'=>1, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
		...
		if(permissionChecker('onlineexamquestionreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$this->data['exam'] = $this->online_exam_m->get_single_online_exam(array('onlineExamID'=>$onlineExamID,'schoolyearID'=>$schoolyearID,'schoolID'=>$schoolID));
					if(customCompute($this->data['exam'])) {
						...
						$examquestions = pluck($this->online_exam_question_m->get_order_by_online_exam_question(array('onlineExamID'=>$onlineExamID,'schoolID'=>$schoolID)),'questionID');
