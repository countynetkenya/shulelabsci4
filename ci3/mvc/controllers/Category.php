...
*/
	...
	public function index() {
		$this->data['categorys'] = $this->category_m->get_join_category(array('schoolID' => $this->session->userdata('schoolID')));
	...
	public function edit() {
		...
		if((int)$id) {
			$schoolID = $this->session->userdata('schoolID');
			$this->data['category'] = $this->category_m->get_single_category(array('categoryID' => $id, 'schoolID' => $schoolID));
	...
	public function delete() {
		$id = htmlentities(escapeString($this->uri->segment(3)));
		if((int)$id) {
			$category = $this->category_m->get_single_category(array('categoryID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
	...
	function unique_class_type(){
		...
		$schoolID = $this->session->userdata('schoolID');
		if((int)$id) {
			$student = $this->category_m->get_order_by_category(array("class_type" => $this->input->post("class_type"), "hostelID" => $this->input->post("hname"), "categoryID !=" => $id, 'schoolID' => $schoolID));
			...
			$student = $this->category_m->get_order_by_category(array("class_type" => $this->input->post("class_type"), "hostelID" => $this->input->post("hname"), 'schoolID' => $schoolID));
