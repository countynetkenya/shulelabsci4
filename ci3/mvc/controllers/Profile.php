...
*/
	...
	private function pluckInfo() {
		...
		$this->data['classess'] = pluck($this->classes_m->general_get_order_by_classes(array('schoolID' => $schoolID)), 'classes', 'classesID');
		$this->data['sections'] = pluck($this->section_m->get_order_by_section(array('schoolID' => $schoolID)), 'section', 'sectionID');
	...
	public function print_preview() {
		...
		$this->data['usertypeID'] =$usertypeID;
		$this->data['usertype'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)), 'usertype', 'usertypeID');
	...
	public function send_mail() {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->data['usertypeID'] = $usertypeID;
				$this->data['usertype'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $this->session->userdata('schoolID'))), 'usertype', 'usertypeID');
				if(customCompute($this->data['user'])) {
