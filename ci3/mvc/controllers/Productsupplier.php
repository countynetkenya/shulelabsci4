...
class Productsupplier extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['suppliers'] = $this->productsupplier_m->get_order_by_productsupplier(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['productsupplier'] = $this->productsupplier_m->get_single_productsupplier(array('productsupplierID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function unique_companyname() {
        ...
        $schoolID = $this->session->userdata('schoolID');
        if((int)$id) {
            $productsupplier = $this->productsupplier_m->get_order_by_productsupplier(array("productsuppliercompanyname" => $this->input->post("productsuppliercompanyname"), "productsupplierID !=" => $id, 'schoolID' => $schoolID));
            ...
            $productsupplier = $this->productsupplier_m->get_order_by_productsupplier(array("productsuppliercompanyname" => $this->input->post("productsuppliercompanyname"), 'schoolID' => $schoolID));
            if(customCompute($productsupplier)) {
                $this->form_validation->set_message("unique_companyname", "The %s is already exists.");
                return FALSE;
            }
