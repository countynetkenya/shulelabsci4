...
class Leaveassign extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['leaveassign'] = $this->leaveassign_m->get_order_by_leaveassign(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function unique_category() {
        ...
        if((int)$id) {
            if((int)$this->input->post('usertypeID')) {
                $result = $this->leaveassign_m->get_single_leaveassign(["leavecategoryID" => $this->input->post('leavecategoryID'), "usertypeID" => $this->input->post('usertypeID'), 'schoolyearID' => $schoolyearID, "leaveassignID !=" => $id, 'schoolID' => $schoolID]);
            ...
            if((int)$this->input->post('usertypeID')) {
                $result = $this->leaveassign_m->get_single_leaveassign(["leavecategoryID" => $this->input->post('leavecategoryID'), "usertypeID" => $this->input->post('usertypeID'), 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID]);
                if(customCompute($result)) {
                    $this->form_validation->set_message("unique_category", "The %s is already assigned!");
                    return FALSE;
                } else {
    ...
    public function add() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            $schoolID = $this->session->userdata('schoolID');
            $this->data['leavecategorys'] = $this->leavecategory_m->get_order_by_leavecategory(array('schoolID' => $schoolID));
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                $schoolID = $this->session->userdata('schoolID');
                $schoolyearID = $this->session->userdata('defaultschoolyearID');
                $this->data['leaveassign'] = $this->leaveassign_m->get_single_leaveassign(array('leaveassignID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                $schoolyearID = $this->session->userdata('defaultschoolyearID');
                $this->data['leaveassign'] = $this->leaveassign_m->get_single_leaveassign(array('leaveassignID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
