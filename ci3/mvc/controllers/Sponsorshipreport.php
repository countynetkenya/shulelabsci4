 ...
 */
        ...
        if (permissionChecker('sponsorshipreport')) {
            if ($_POST) {
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    $this->data['sponsorships'] = $this->sponsorship_m->get_sponsorship_for_report(array('id' => $this->data['typeId'], 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function pdf()
    {
        if (permissionChecker('sponsorshipreport')) {
            ...
            if (((int) $typeId > 0)) {
                ...
                $this->data['sponsorships'] = $this->sponsorship_m->get_sponsorship_for_report(array('id' => $typeId, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    private function xmlData()
    {
        if (permissionChecker('sponsorshipreport')) {
            $typeId = htmlentities(escapeString($this->uri->segment(3)));
            if (((int) $typeId > 0)) {
                $sponsorships = $this->sponsorship_m->get_sponsorship_for_report(array('id' => $typeId, 'schoolID' => $this->session->userdata('schoolID')));
