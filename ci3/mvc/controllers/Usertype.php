...
*/
	...
	public function index() {
		...
		$this->data['usertypes'] = $this->usertype_m->get_order_by_usertype(array('schoolID' => $schoolID));
	...
	public function edit() {
		...
		if((int)$id) {
			$this->data['usertype'] = $this->usertype_m->get_single_usertype(array('usertypeID' => $id, 'schoolID' => $schoolID));
