...
class Productcategory extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['productcategorys'] = $this->productcategory_m->get_order_by_productcategory(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['productcategory'] = $this->productcategory_m->get_single_productcategory(array('productcategoryID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function unique_productcategoryname() {
        ...
        $schoolID = $this->session->userdata('schoolID');
        if((int)$id) {
            $product = $this->productcategory_m->get_order_by_productcategory(array("productcategoryname" => $this->input->post("productcategoryname"), "productcategoryID !=" => $id, "schoolID" => $schoolID));
            ...
            $product = $this->productcategory_m->get_order_by_productcategory(array("productcategoryname" => $this->input->post("productcategoryname"), "schoolID" => $schoolID));
            if(customCompute($product)) {
                $this->form_validation->set_message("unique_productcategoryname", "The %s is already exists.");
                return FALSE;
            }
