...
class Pages extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['pagess'] = $this->pages_m->get_pages();
                ...
                if(!empty($this->input->post('hidden_slider_images'))) {
                    ...
                    if(customCompute($expImg)) {
                        foreach ($expImg as $expKey => $expValue) {
                            if(!empty($expValue)) {
                                $callImage = $this->media_gallery_m->get_media_gallery($expValue);
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['pages'] = $this->pages_m->get_pages($id);
            if($this->data['pages']) {
    ...
    public function getFileInfo() {
        ...
        if((int) $id && $media_type) {
            $this->data['image_info'] = $this->media_gallery_m->get_media_gallery($id);
