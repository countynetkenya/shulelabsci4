...
*/
	function __construct() {
 	...
 	public function index() {
		...
		$this->data['teachers'] = $this->teacher_m->general_get_order_by_teacher(array('schoolID' => $schoolID));
			    ...
			    exit;
					...
					if($routinefor == 'student') {
						if((int)$classesID && (int)$sectionID) {
							$this->data['routines'] = pluck_multi_array($this->routine_m->get_order_by_routine(array('classesID'=>$classesID,'sectionID'=>$sectionID,'schoolyearID'=> $schoolyearID,'schoolID'=>$schoolID)), 'obj', 'day');
							$this->data['subjects'] = pluck($this->subject_m->general_get_order_by_subject(array('classesID'=>$classesID, 'schoolID'=>$schoolID)), 'subject', 'subjectID');
							$this->data['classes'] = $this->classes_m->general_get_single_classes(array('classesID'=>$classesID, 'schoolID'=>$schoolID));
							$this->data['sections'] = pluck($this->section_m->general_get_order_by_section(array('classesID'=>$classesID, 'schoolID'=>$schoolID)), 'section', 'sectionID');
							$this->data['teachers'] = pluck($this->teacher_m->general_get_order_by_teacher(array('schoolID' => $schoolID)), 'name', 'teacherID');
						...
						if ((int)$teacherID) {
							$this->data['routines'] = pluck_multi_array($this->routine_m->get_order_by_routine(array('teacherID'=>$teacherID,'schoolyearID'=>$schoolyearID, 'schoolID'=>$schoolID)), 'obj', 'day');
					...
					if((string)$routinefor && ((int)$teacherID >= 0) && ((int)$classesID >= 0) && ((int)$sectionID >= 0)) {
						...
						if($routinefor == 'student') {
							if((int)$classesID && (int)$sectionID) {
								...
								$classess = $this->classes_m->get_single_classes(array('classesID' => $classesID, 'schoolID' => $schoolID));
								$sections = $this->section_m->get_single_section(array('sectionID' => $sectionID, 'schoolID' => $schoolID));
