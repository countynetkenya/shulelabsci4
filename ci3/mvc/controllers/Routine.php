...
*/
	...
	public function index() {
		...
		if((int)$id) {
			...
			$this->data['routines'] = $this->routine_m->get_routine_with_teacher_class_section_subject(array('classesID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function add() {
		...
		if($classesID > 0) {
			...
			if($this->input->post('subjectID') > 0) {
				$this->data['teachers'] = $this->subjectteacher_m->get_subjectteacher_with_teacher(array('subjectID' => $this->input->post('subjectID'), 'schoolID' => $schoolID));
			}
		} else {
			$this->data['subjects'] = [];
			$this->data['sections'] = [];
	...
	public function edit() {
		...
		if((int)$id && (int)$url) {
			if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$schoolID = $this->session->userdata('schoolID');
				$this->data['routine'] = $this->routine_m->get_single_routine(array('routineID' => $id, 'classesID' => $url, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
				if(customCompute($this->data['routine'])) {
					...
					$this->data['classes'] = $this->classes_m->get_order_byclasses(array("schoolID" => $schoolID));
					$this->data['schoolyears'] = $this->schoolyear_m->get_order_by_schoolyear(array("schoolID" => $schoolID));
		...
		if((int)$routineID && (int)$classesID) {
			if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
				...
				if(isset($fetchClass[$classesID])) {
					$routine = $this->routine_m->get_order_by_routine(array('routineID' => $routineID, 'classesID' => $classesID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function unique_teacher() {
		...
		$id = htmlentities(escapeString($this->uri->segment(3)));
		if((int)$id) {
			$routine = $this->routine_m->get_order_by_routine(array('day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'schoolyearID' => $this->input->post('schoolyearID'), 'teacherID' => $this->input->post('teacherID'), 'routineID !=' => $id, 'schoolID' => $schoolID));
			if(customCompute($routine)) {
			...
			$routine = $this->routine_m->get_order_by_routine(array('day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'teacherID' => $this->input->post('teacherID'), 'schoolyearID' => $this->input->post('schoolyearID'), 'schoolID' => $schoolID));
			if(customCompute($routine)) {
				$this->form_validation->set_message("unique_teacher", "%s already assign another schedule in this time.");
				return FALSE;
			}
	...
	public function teachercall() {
		...
		if((int)$subjectID) {
			$schoolID = $this->session->userdata('schoolID');
			$teachers = $this->subjectteacher_m->get_subjectteacher_with_teacher(array('subjectID' => $subjectID, 'schoolID' => $schoolID));
	...
	public function subjectcall() {
		...
		if((int)$classID) {
			$schoolID 	= $this->session->userdata('schoolID');
			$allclasses = $this->subject_m->general_get_order_by_subject(array('classesID' => $classID, 'schoolID' => $schoolID));
	...
	public function sectioncall() {
		...
		if((int)$classID) {
			$schoolID 	= $this->session->userdata('schoolID');
			$allsection = $this->section_m->general_get_order_by_section(array('classesID' => $classID, 'schoolID' => $schoolID));
	...
	public function unique_room() {
		...
		$id = htmlentities(escapeString($this->uri->segment(3)));
		if((int)$id) {
			$routine = $this->routine_m->get_order_by_routine(array('day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'room' => $this->input->post('room'), 'schoolyearID' => $this->input->post('schoolyearID'), 'routineID !=' => $id, 'schoolID' => $schoolID));
			if(customCompute($routine)) {
			...
			$routine = $this->routine_m->get_order_by_routine(array('day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'room' => $this->input->post('room'), 'schoolyearID' => $this->input->post('schoolyearID'), 'schoolID' => $schoolID));
			if(customCompute($routine)) {
				$this->form_validation->set_message("unique_room", "%s already exists this time.");
				return FALSE;
			}
	...
	public function unique_section() {
		...
		$id = htmlentities(escapeString($this->uri->segment(3)));
		if((int)$id) {
			$routine = $this->routine_m->get_order_by_routine(array('classesID' => $this->input->post('classesID'), 'day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'sectionID' => $this->input->post('sectionID'), 'schoolyearID' => $this->input->post('schoolyearID'), 'routineID !=' => $id, 'schoolID' => $schoolID));
			if(customCompute($routine)) {
			...
			$routine = $this->routine_m->get_order_by_routine(array('classesID' => $this->input->post('classesID'), 'day' => $this->input->post('day'), 'start_time' => $this->input->post('start_time'), 'end_time' => $this->input->post('end_time'), 'sectionID' => $this->input->post('sectionID'), 'schoolyearID' => $this->input->post('schoolyearID'), 'schoolID' => $schoolID));
			if(customCompute($routine)) {
				$this->form_validation->set_message("unique_section", "%s already exists");
				return FALSE;
			}
