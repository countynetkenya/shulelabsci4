...
class Inventory_transfer_memo extends Admin_Controller
{
    /*
    | -----------------------------------------------------
    ...
    */
    ...
    function __construct()
    {
        ...
        $this->lang->load('inventory_transfer_memo', $language);
    }
    ...
    public function index()
    {
        ...
        $this->data['mainstocks']        = $this->mainstock_m->get_order_by_mainstock(array('schoolID' => $schoolID, 'type' => 'movement'));
        ...
        $this->data["subview"]           = "inventory_transfer_memo/index";
    ...
    public function add() {
        ...
        $this->data["subview"] = "inventory_transfer_memo/add";
        $this->load->view('_layout_main', $this->data);
    }
    ...
    public function savemovement()
    {
        ...
        if(permissionChecker('inventory_transfer_memo_add')) {
            if($_POST) {
                $rules = $this->rules();
    ...
    public function view()
    {
        ...
        if((int)$id) {
            ...
            if(customCompute($this->data["mainstock"])) {
                ...
                $this->data["subview"] = "inventory_transfer_memo/view";
                $this->load->view('_layout_main', $this->data);
            } else {
    ...
    public function approve() {
        ...
        if((int)$id) {
            ...
            if($this->data['stock'] && $this->session->userdata('loginuserID') != $this->data['stock']->create_userID) {
                ...
                $this->session->set_flashdata('success', $this->lang->line('menu_success'));
                redirect(base_url("inventory_transfer_memo/index"));
            } else {
                redirect(base_url("inventory_transfer_memo/index"));
            }
        } else {
