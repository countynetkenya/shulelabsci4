		...
		if(permissionChecker('progresscardreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$mArray     = ['schoolyearID' => $schoolyearID, 'schoolID' => $schoolID];
					$queryArray = ['srschoolyearID' => $schoolyearID, 'srschoolID' => $schoolID];
					if((int)$classesID > 0) {
					...
					$optionalSubjects       = $this->subject_m->general_get_order_by_subject(array('classesID' => $classesID, 'type' => 0, 'schoolID' => $schoolID));
