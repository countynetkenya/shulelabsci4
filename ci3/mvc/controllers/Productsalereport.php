          ...
          if(customCompute($productsales)) {
              foreach($productsales as $product) {
                  ...
                  if(isset($productArray[$product->productsaleID])) {
                      ...
                      $productArray[$product->productsaleID]['productsalecustomertype'] = isset($usertypes[$product->productsalecustomertypeID]) ? $usertypes[$product->productsalecustomertypeID] : ($product->productsalecustomertypeID == "school" ? 'School' : '');
