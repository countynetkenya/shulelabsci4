...
class Visitorinfo extends Admin_Controller {
	...
	public function index() {
		...
		$this->data['to_meet'] = 0;
    $this->data['passes'] = $this->visitorinfo_m->get_order_by_visitorinfo(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function logout() {
		...
		$schoolID = $this->session->userdata('schoolID');
		if((int)$id) {
			$visitorinfo = $this->visitorinfo_m->get_single_visitorinfo(array('visitorID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
