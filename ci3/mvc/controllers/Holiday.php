...
*/
	...
	public function index() {
		...
		$this->data['holidays'] = $this->holiday_m->get_order_by_holiday(array('schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function photoupload() {
		...
		$holiday = array();
		if((int)$id) {
			$holiday = $this->holiday_m->get_single_holiday(array('holidayID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
		}
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) {
			...
			$id = htmlentities(escapeString($this->uri->segment(3)));
			if((int)$id) {
				$this->data['holiday'] = $this->holiday_m->get_single_holiday(array('schoolyearID' => $schoolyearID, 'holidayID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
