...
class Childcare extends Admin_Controller {
    ...
    $this->data['drop_receive'] = $this->childcare_m->get_join_childcare_all(array('schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function add() {
      ...
      if($this->input->post('classesID')) {
      	$this->data['students'] = $this->studentrelation_m->get_order_by_student(array('srschoolyearID' => $schoolyearID, 'srclassesID' => $this->input->post('classesID'), 'srschoolID' => $schoolID));
      } else {
      	$this->data['students'] = [];
      }
	        ...
	        if($this->input->post('userID')) {
	        	$student = $this->student_m->get_single_student(array('studentID' => $this->input->post('userID'), 'schoolID' => $schoolID));
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id) {
				$this->data['careinfo'] = $this->childcare_m->get_single_childcare(array('childcareID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	        ...
	        if($this->input->post('classesID')) {
	        	...
	        	$this->data['students'] = $this->studentrelation_m->get_order_by_student(array('srschoolyearID' => $schoolyearID, 'srclassesID' => $this->data['careinfo']->classesID, 'srschoolID' => $schoolID));
	        }
	...
	public function all_student() {
		...
		$schoolyearID = $this->session->userdata('defaultschoolyearID');
		if((int)$classesID) {
            $this->data['users'] = $this->studentrelation_m->get_order_by_student(array('srclassesID' => $classesID, 'srschoolyearID' => $schoolyearID, 'srschoolID' => $this->session->userdata('schoolID')));
	...
	public function delete() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			$schoolyearID = $this->session->userdata('defaultschoolyearID');
			if((int)$id) {
				$this->data['childcare'] = $this->childcare_m->get_single_childcare(array('childcareID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
