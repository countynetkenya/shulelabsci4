...
class Question_level extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['question_levels'] = $this->question_level_m->get_order_by_question_level(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['question_level'] = $this->question_level_m->get_single_question_level(array('questionLevelID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
