...
class Hourly_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['hourly_templates'] = $this->hourly_template_m->get_order_by_hourly_template(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['hourly_template'] = $this->hourly_template_m->get_single_hourly_template(array('hourly_templateID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function unique_hourly_grades() {
        ...
        $schoolID = $this->session->userdata('schoolID');
        if((int) $id) {
            $hourly_grades = $this->hourly_template_m->get_single_hourly_template(array('hourly_grades' => $this->input->post("hourly_grades"), 'hourly_templateID !=' => $id, 'schoolID' => $schoolID));
            ...
            $hourly_grades = $this->hourly_template_m->get_single_hourly_template(array('hourly_grades' => $this->input->post('hourly_grades'), 'schoolID' => $schoolID));
            if(customCompute($hourly_grades)) {
                $this->form_validation->set_message("unique_hourly_grades", "%s already exists");
                return FALSE;
            }
