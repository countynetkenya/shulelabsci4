    ...
    public function add() {
        ...
        if(permissionChecker('make_payment')) {
            ...
            if((int)$userID && (int) $usertypeID) {
                ...
                $this->data['make_payments'] = $this->make_payment_m->get_order_by_make_payment(array('usertypeID' => $usertypeID, 'userID' => $userID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function view() {
        if(permissionChecker('make_payment')) {
            ...
            if((int)$id) {
                ...
                $this->data['make_payment'] = $this->make_payment_m->get_single_make_payment(array('make_paymentID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            if(permissionChecker('make_payment')) {
                ...
                if((int)$id) {
                    $schoolyearID = $this->session->userdata('defaultschoolyearID');
                    $this->data['make_payment'] = $this->make_payment_m->get_single_make_payment(array('make_paymentID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
                    if($this->data['make_payment']) {
