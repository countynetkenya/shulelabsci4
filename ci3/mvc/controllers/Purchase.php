...
class Purchase extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['purchases'] = $this->purchase_m->get_purchase_with_all(array('purchase.schoolID' => $this->session->userdata('schoolID')));
    ...
    public function add() {
        ...
        $this->data['users'] = $this->user_m->get_order_by_user(array('schoolID' => $schoolID));
        $this->data['assets'] = $this->asset_m->get_order_by_asset(array('schoolID' => $schoolID));
        $this->data['vendors'] = $this->vendor_m->get_order_by_vendor(array('schoolID' => $schoolID));
        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if($this->input->post('purchased_by')) {
                    $user = $this->user_m->get_single_user(array('userID' => $this->input->post('purchased_by'), 'schoolID' => $schoolID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['purchase'] = $this->purchase_m->get_single_purchase_with_all(array('purchaseID' => $id, 'purchase.schoolID' => $schoolID));
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['purchase'] = $this->purchase_m->get_single_purchase(array('purchaseID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['purchase']) {
    ...
    function status() {
        if(permissionChecker('purchase_edit')) {
            ...
            if($id != '') {
                if((int)$id) {
                    $purchase = $this->purchase_m->get_single_purchase(array('purchaseID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
