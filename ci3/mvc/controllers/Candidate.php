 ...
 */
    ...
    public function index()
    {
        ...
        $this->data['sponsors']   = pluck($this->sponsor_m->get_order_by_sponsor(array('schoolID' => $schoolID)), 'name', 'sponsorID');
        $this->data['candidates'] = $this->candidate_m->get_candidate_with_student_sponsorship(array('schoolID' => $schoolID));
    ...
    public function add()
    {
        ...
        $this->data['students']         = $this->studentrelation_m->get_order_by_student(['srschoolyearID' => $this->session->userdata('defaultschoolyearID'), 'schoolID' => $this->session->userdata('schoolID')]);
    ...
    public function edit()
    {
        ...
        $schoolID                       = $this->session->userdata('schoolID');
        if ((int) $candidateID) {
            $this->data['candidate'] = $this->candidate_m->get_single_candidate(['candidateID' => $candidateID, 'schoolID' => $schoolID]);
            $this->data['students']  = $this->studentrelation_m->get_order_by_studentrelation(['srschoolyearID' => $schoolyearID, 'srschoolID' => $schoolID]);
                ...
                if (customCompute($this->data['studentInfo'])) {
                    if ($_POST) {
                        ...
                        if ($this->form_validation->run() == false) {
                            ...
                            $candidate = $this->candidate_m->get_single_candidate(['candidateID' => $candidateID, 'schoolID' => $schoolID]);
    ...
    public function view()
    {
        ...
        if ((int) $candidateID) {
            ...
            $this->data['candidate'] = $this->candidate_m->get_single_candidate(['candidateID' => $candidateID, 'schoolID' => $schoolID]);
            if (customCompute($this->data['candidate'])) {
                $this->data['photo']   = pluck($this->student_m->general_get_order_by_student(array('schoolID' => $schoolID)),'photo','studentID');
                $this->data['profile']   = $this->studentrelation_m->get_single_studentrelation(['srstudentID' => $this->data['candidate']->studentID, 'srschoolID' => $schoolID]);
                ...
                $this->data['classes']   = $this->classes_m->get_single_classes(['classesID' => $this->data['profile']->srclassesID, 'schoolID' => $schoolID]);
                $this->data['section']   = $this->section_m->get_single_section(['sectionID' => $this->data['profile']->srsectionID, 'schoolID' => $schoolID]);
                $this->data['sponsors']   = pluck($this->sponsor_m->get_order_by_sponsor(array('schoolID' => $schoolID)), 'name', 'sponsorID');
    ...
    public function print_preview()
    {
        ...
        if ((int) $candidateID) {
            ...
            $this->data['candidate'] = $this->candidate_m->get_single_candidate(['candidateID' => $candidateID, 'schoolID' => $schoolID]);
            if (customCompute($this->data['candidate'])) {
                $this->data['profile']   = $this->studentrelation_m->get_single_student(['srstudentID' => $this->data['candidate']->studentID, 'srschoolID' => $schoolID]);
                $this->data['usertypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)), 'usertype', 'usertypeID');
                $this->data['classes']   = $this->classes_m->get_single_classes(['classesID' => $this->data['profile']->srclassesID, 'schoolID' => $schoolID]);
    ...
    public function delete()
    {
        ...
        if ((int) $candidateID) {
            ...
            if (customCompute($candidate)) {
                $sponsorship = $this->sponsorship_m->get_order_by_sponsorship(['candidateID' => $candidateID, 'schoolID' => $schoolID]);
    ...
    public function check_student($studentID)
    {
        ...
        $schoolID = $this->session->userdata('schoolID');
        if ((int) $candidateID) {
            $candidate = $this->candidate_m->get_single_candidate(['studentID' => $studentID, 'candidateID !=' => $candidateID, 'schoolID' => $schoolID]);
        } else {
            $candidate = $this->candidate_m->get_single_candidate(['studentID' => $studentID, 'schoolID' => $schoolID]);
        }
        if (customCompute($candidate)) {
    ...
    public function getSection()
    {
        ...
        if ((int) $classesID) {
            $sections = $this->section_m->general_get_order_by_section(array('classesID' => $classesID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    private function getStudentInfo($studentID)
    {
        ...
        if ((int) $studentID) {
            ...
            if (customCompute($student)) {
                ...
                $section                 = $this->section_m->general_get_single_section(['sectionID' => $student->srsectionID, 'schoolID' => $schoolID]);
                $classes                 = $this->classes_m->general_get_single_classes(['classesID' => $student->srclassesID, 'schoolID' => $schoolID]);
