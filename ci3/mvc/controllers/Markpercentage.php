...
*/
    ...
    public function index()
    {
        ...
        $this->data['markpercentage'] = $this->markpercentage_m->get_order_by_markpercentage(array('schoolID' => $schoolID));
    ...
    public function edit()
    {
        ...
        if ( (int) $id ) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['markpercentage'] = $this->markpercentage_m->get_single_markpercentage(array('markpercentageID' => $id, 'schoolID' => $schoolID));
