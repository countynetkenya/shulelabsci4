...
class Leavecategory extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['leave_categories'] = $this->leavecategory_m->get_order_by_leavecategory(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function unique_leavecategory($leavecategory) {
        ...
        if((int)$leavecategoryID) {
            $leavecategory = $this->leavecategory_m->get_order_by_leavecategory(array('leavecategory'=>$leavecategory,'leavecategoryID !='=>$leavecategoryID, 'schoolID' => $schoolID));
        } else {
            $leavecategory = $this->leavecategory_m->get_order_by_leavecategory(array('leavecategory'=>$leavecategory, 'schoolID' => $schoolID));
        }
    ...
    public function edit() {
        $leavecategoryID = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$leavecategoryID) {
            $this->data['leavecategory'] = $this->leavecategory_m->get_single_leavecategory(array('leavecategoryID' => $leavecategoryID, 'schoolID' => $this->session->userdata('schoolID')));
