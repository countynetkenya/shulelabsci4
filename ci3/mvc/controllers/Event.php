...
*/
	...
	public function index() {
		...
		$this->data['events'] = $this->event_m->get_order_by_event(array('schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function photoupload() {
		...
		$event = array();
		if((int)$id) {
			$event = $this->event_m->get_single_event(array('eventID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
		}
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id) {
				$schoolyearID = $this->session->userdata("defaultschoolyearID");
				$this->data['event'] = $this->event_m->get_single_event(array('eventID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function view() {
		...
		if((int)$id) {
			...
			$this->data['event'] = $this->event_m->get_single_event(array('eventID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));

			$this->data['id'] = $id;
			$this->data['goings'] = $this->eventcounter_m->get_order_by_eventcounter(array('eventID' => $id, 'status' => 1, 'schoolID' => $schoolID));
			$this->data['ignores'] = $this->eventcounter_m->get_order_by_eventcounter(array('eventID' => $id, 'status' => 0, 'schoolID' => $schoolID));
			if(customCompute($this->data['event'])) {
	...
	public function delete() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id) {
				$schoolyearID = $this->session->userdata("defaultschoolyearID");
				$event = $this->event_m->get_single_event(array('eventID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
				if(customCompute($event)) {
	...
	public function eventcounter() {
		...
		$schoolID = $this->session->userdata('schoolID');
		if($eventID) {
			$have = $this->eventcounter_m->get_order_by_eventcounter(array("eventID" => $eventID, "username" => $username, "type" => $usertype, "schoolID" => $schoolID),TRUE);
