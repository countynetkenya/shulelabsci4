  ...
  public function unique_data($data) {
	...
	public function getProductpurchaseReport() {
		...
		if(permissionChecker('productpurchasereport')) {
          ...
          $productpurchasepaids = $this->productpurchasepaid_m->get_order_by_productpurchasepaid(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function send_pdf_to_mail() {
		...
		if(permissionChecker('productpurchasereport')) {
          ...
          $productsuppliers = pluck($this->productsupplier_m->get_productsupplier(array('schoolID' => $schoolID)), 'productsuppliercompanyname', 'productsupplierID');
          $productwarehouses = pluck($this->productwarehouse_m->get_productwarehouse(array('schoolID' => $schoolID)), 'productwarehousename', 'productwarehouseID');
          $this->data['productsuppliers'] = $productsuppliers;
          $this->data['productwarehouses'] = $productwarehouses;
