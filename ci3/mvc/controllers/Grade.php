...
*/
	...
	public function edit() {
		...
		if((int)$id) {
			$schoolID = $this->session->userdata('schoolID');
			$this->data['grade'] = $this->grade_m->get_single_grade(array('gradeID' => $id, 'schoolID' => $schoolID));
			if($this->data['grade']) {
				if($_POST) {
					$rules = $this->rules();
					$this->form_validation->set_rules($rules);
	...
	public function delete() {
		...
		if((int)$id) {
			$schoolID = $this->session->userdata('schoolID');
			$grade = $this->grade_m->get_single_grade(array('gradeID' => $id, 'schoolID' => $schoolID));
	...
	public function unique_gradefrom() {
		...
		if((int)$id) {
			if($this->input->post("gradefrom") != '') {
				$grade = $this->grade_m->get_order_by_grade(array("gradefrom" => $this->input->post("gradefrom"), "schoolID" => $schoolID, "gradeID !=" => $id));
				if(customCompute($grade)) {
			...
			if($this->input->post("gradefrom") != '') {
				$grade = $this->grade_m->get_order_by_grade(array("gradefrom" => $this->input->post("gradefrom"), "schoolID" => $schoolID));
				if(customCompute($grade)) {
					$this->form_validation->set_message("unique_gradefrom", "%s already exists");
					return FALSE;
				}
	...
	public function unique_gradeupto() {
		...
		if((int)$id) {
			if($this->input->post("gradeupto") != '') {
				$grade = $this->grade_m->get_order_by_grade(array("gradeupto" => $this->input->post("gradeupto"), "schoolID" => $schoolID, "gradeID !=" => $id));
				if(customCompute($grade)) {
			...
			if($this->input->post("gradeupto") != '') {
				$grade = $this->grade_m->get_order_by_grade(array("gradeupto" => $this->input->post("gradeupto"), "schoolID" => $schoolID));
				if(customCompute($grade)) {
					$this->form_validation->set_message("unique_gradeupto", "%s already exists");
					return FALSE;
				}
