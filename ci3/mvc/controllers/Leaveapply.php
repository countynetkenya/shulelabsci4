...
class Leaveapply extends Admin_Controller
{
    ...
    */
    ...
    public function index() {
        ...
        $this->data['myleaveapplications'] = $this->leaveapplication_m->get_order_by_leaveapplication(array('schoolyearID' => $schoolyearID, 'create_usertypeID' => $this->session->userdata('usertypeID'), 'create_userID' => $this->session->userdata('loginuserID'), 'schoolID' => $schoolID));
        $this->data['leavecategorys'] = pluck($this->leavecategory_m->get_order_by_leavecategory(array('schoolID' => $schoolID)), 'leavecategory', 'leavecategoryID');
        $this->data['userName'] = getAllUserObjectWithStudentRelation(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function attachmentUpload() {
        ...
        $leaveapplication = [];
        if ((int)$id) {
            $leaveapplication = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
        }
    ...
    public function add() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            $this->data['leavecategories'] = $this->leavecategory_m->get_join_leavecategory_and_leaveassign(array('usertypeID' => $this->session->userdata('usertypeID'), 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                ...
                $this->data['leaveapplication'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID, 'create_usertypeID' => $this->session->userdata('usertypeID'), 'create_userID' => $this->session->userdata('loginuserID'), 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            ...
            if((int)$id) {
                $schoolyearID      = $this->session->userdata("defaultschoolyearID");
                $leaveapplication = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID, 'create_usertypeID' => $this->session->userdata('usertypeID'), 'create_userID' => $this->session->userdata('loginuserID'), 'schoolID' => $this->session->userdata('schoolID')));
                if (customCompute($leaveapplication)) {
    ...
    public function usercall() {
        ...
        if((int)$usertypeID) {
            ...
            if($usertypeID == 1) {
                $this->data['users'] = $this->systemadmin_m->get_order_by_systemadmin(array('schoolID' => $schoolID));
                ...
                $this->data['users'] = $this->teacher_m->get_order_by_teacher(array('schoolID' => $schoolID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(customCompute($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->studentrelation_m->get_order_by_student(array('srschoolyearID' => $schoolyearID, 'srschoolID' => $schoolID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(customCompute($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->parents_m->get_order_by_parents(array('schoolID' => $schoolID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(customCompute($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
                ...
                $this->data['users'] = $this->user_m->get_order_by_user(array('usertypeID' => $usertypeID, 'schoolID' => $schoolID));
                echo "<option value='0'>", $this->lang->line("leaveapply_select_user"),"</option>";
                if(customCompute($this->data['users'])) {
                    foreach ($this->data['users'] as $value) {
    ...
    public function download() {
        ...
        if(permissionChecker('leaveapply')) {
            ...
            if((int)$leaveapplicationID) {
                $leaveapply = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $leaveapplicationID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function view() {
        ...
        if ((int)$id) {
            ...
            $this->data['leaveapply'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
            ...
            if(customCompute($this->data['leaveapply'])) {
                if(($this->data['leaveapply']->create_userID == $this->session->userdata('loginuserID')) && ($this->data['leaveapply']->create_usertypeID == $this->session->userdata('usertypeID'))) {
                    ...
                    $leavecategory = $this->leavecategory_m->get_single_leavecategory(array('leavecategoryID' => $this->data['leaveapply']->leavecategoryID, 'schoolID' => $schoolID));
                    ...
                    $leaveassign = $this->leaveassign_m->get_single_leaveassign(array('leavecategoryID' => $this->data['leaveapply']->leavecategoryID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
            ...
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if((int)$leaveapplicationID) {
                        ...
                        $schoolyearID  = $this->session->userdata("defaultschoolyearID");
                        $this->data['usertypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)),'usertype','usertypeID');
                        $this->data['leaveapply'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $leaveapplicationID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
