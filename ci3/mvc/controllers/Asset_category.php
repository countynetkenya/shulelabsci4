...
class Asset_category extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['asset_categorys'] = $this->asset_category_m->get_order_by_asset_category(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['asset_category'] = $this->asset_category_m->get_single_asset_category(array('asset_categoryID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
