...
class Instruction extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['instructions'] = $this->instruction_m->get_order_by_instruction(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['instruction'] = $this->instruction_m->get_single_instruction(array('instructionID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
