...
*/
			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					if(customCompute($users)) {
						...
						$this->data['uattendances'] = pluck($this->uattendance_m->get_order_by_uattendance(array('monthyear' => $monthyear, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID)), 'obj', 'userID');
	...
	public function view($id = null) {
		...
		if ((int)$id) {
			...
			$schoolyearID = $this->session->userdata('defaultschoolyearID');
			$schoolID = $this->session->userdata('schoolID');
			$this->data["user"] = $this->user_m->get_single_user(array('userID' => $id, 'schoolID' => $schoolID));
