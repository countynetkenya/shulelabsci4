...
*/
	...
	public function index() {
		...
		$this->data['expenses'] = $this->expense_m->get_order_by_expense(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function fileupload() {
		...
		$expense = [];
		if((int)$id) {
			$expense = $this->expense_m->get_single_expense(array('expenseID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
		}
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) {
			...
			if((int)$id) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$this->data['expense'] = $this->expense_m->get_single_expense(array('expenseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function delete() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) {
			...
			if((int)$id) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$expense = $this->expense_m->get_single_expense(array('expenseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
				if(customCompute($expense)) {
