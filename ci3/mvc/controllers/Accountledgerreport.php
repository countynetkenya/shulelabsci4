...
*/
	...
	protected function send_pdf_to_mail_rules() {
 	...
 	public function index() {
		...
		$this->data['schoolyears'] = $this->schoolyear_m->get_order_by_schoolyear(array('schoolID' => $this->session->userdata('schoolID')));
	...
	public function queryArray($array) {
		...
		$retArray['schoolID'] = $schoolID;
		$schoolyear = $this->schoolyear_m->get_single_schoolyear(array('schoolyearID'=>$array['schoolyearID'],'schoolID'=>$schoolID));
