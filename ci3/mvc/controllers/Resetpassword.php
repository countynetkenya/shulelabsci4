...
*/
	...
	public function index() {
		...
		if($userID != '0') {
			...
			$this->data['usernames'] = $this->resetpassword_m->get_username($table, array('usertypeID' => $userID, 'schoolID' => $schoolID));
		} else {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->resetpassword_m->update_resetpassword($table, $array, array($tableID => $userID, 'schoolID' => $schoolID));
	...
	public function userscall() {
		...
		if($userID) {
			...
			$schoolID = $this->session->userdata('schoolID');
			$get_users = $this->resetpassword_m->get_username($table, array('usertypeID' => $userID, 'schoolID' => $schoolID));
