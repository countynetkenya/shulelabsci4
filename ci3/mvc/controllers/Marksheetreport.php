...
*/
		...
		if(permissionChecker('marksheetreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$exams                  = $this->exam_m->get_single_exam(['examID'=> $examID, 'schoolID' => $schoolID]);
					...
					$marks                  = $this->mark_m->student_all_mark_array(array('examID'=>$examID,'classesID'=>$classesID, 'schoolyearID'=>$schoolyearID, 'schoolID'=>$schoolID));
					$mandatorySubjects      = $this->subject_m->general_get_order_by_subject(array('classesID' => $classesID, 'type' => 1, 'schoolID' => $schoolID));
					$subjects               = pluck($this->subject_m->general_get_order_by_subject(array('classesID' => $classesID, 'schoolID' => $schoolID)), 'obj', 'subjectID');
	...
	public function getExam() {
		...
		if((int)$classesID) {
			$exams    = pluck($this->marksetting_m->get_exam(array('marktypeID' => $this->data['siteinfos']->marktypeID, 'classesID' => $classesID, 'schoolID' => $this->session->userdata('schoolID'))), 'obj', 'examID');
