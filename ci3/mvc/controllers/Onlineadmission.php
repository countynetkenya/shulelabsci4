 ...
 */
    ...
    public function index()
    {
        ...
        if ((int) $id) {
            ...
            $this->data['onlineadmissions'] = $this->onlineadmission_m->get_where_in_onlineadmission(array(0, 2), 'status', array('classesID' => $id, 'schoolID' => $schoolID));
        } else {
    ...
    public function view()
    {
        if (permissionChecker('onlineadmission')) {
            ...
            if ((int) $id) {
                $schoolID                    = $this->session->userdata('schoolID');
                $this->data['admissioninfo'] = $this->onlineadmission_m->get_where_in_onlineadmission(array(0, 2), 'status', array('onlineadmissionID' => $id, array('schoolID' => $schoolID)));
                if (customCompute($this->data['admissioninfo'])) {
                    ...
                    $this->data['classes']       = $this->classes_m->general_get_single_classes(array('classesID' => $classesID, 'schoolID' => $schoolID));
    ...
    public function print_preview()
    {
        if (permissionChecker('onlineadmission')) {
            ...
            if ((int) $id) {
                $schoolID                    = $this->session->userdata('schoolID');
                $this->data['admissioninfo'] = $this->onlineadmission_m->get_where_in_onlineadmission(array(0, 2), 'status', array('onlineadmissionID' => $id, 'schoolID' => $schoolID));
                ...
                if (customCompute($this->data['admissioninfo'])) {
                    ...
                    if ($_POST) {
                        ...
                        if ($this->form_validation->run() == false) {
                            ...
                            $classes = $this->classes_m->general_get_single_classes(array('classesID' => $this->input->post("classesID"), 'schoolID' => $schoolID));
    ...
    public function download_documentd()
    {
        ...
        if ((int) $id && (int) $classesID) {
            if ((permissionChecker('onlineadmission'))) {
                $document = $this->onlineadmission_m->get_single_onlineadmission(array('onlineadmissionID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function decline()
    {
        if (permissionChecker('onlineadmission')) {
            ...
            $url = htmlentities(escapeString($this->uri->segment(4)));
            if ((int) $id && (int) $url) {
                $onlineadmission = $this->onlineadmission_m->get_where_in_onlineadmission(array(0, 2), 'status', array('onlineadmissionID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function photoupload()
    {
        ...
        if ((int) $id) {
            $onlineadmission = $this->onlineadmission_m->get_single_onlineadmission(array('onlineadmissionID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
        }
    ...
    public function optionalsubjectcall()
    {
        $classesID = $this->input->post('id');
        if ((int) $classesID) {
            $allOptionalSubjects = $this->subject_m->general_get_order_by_subject(array("classesID" => $classesID, 'type' => 0, 'schoolID' => $this->session->userdata('schoolID')));
