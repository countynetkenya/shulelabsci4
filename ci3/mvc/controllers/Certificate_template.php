...
class Certificate_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['certificate_templates'] = $this->certificate_template_m->get_order_by_certificate_template(array('schoolID' => $schoolID));
    ...
    public function photoupload() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $certificate_template = $this->certificate_template_m->get_single_certificate_template(array('certificate_templateID' => $id, 'schoolID' => $schoolID));
        }
    ...
    public function edit() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['certificate_template'] = $this->certificate_template_m->get_single_certificate_template(array('certificate_templateID' => $id, 'schoolID' => $schoolID));
