		...
		if(permissionChecker('classesreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$classes  = $this->classes_m->general_get_single_classes(array('classesID' => $classID, 'schoolID' => $schoolID));
					$subjects = $this->subject_m->general_get_order_by_subject(array( 'classesID' => $classID, 'schoolID' => $schoolID));
					$teachers = pluck($this->teacher_m->general_get_order_by_teacher(array('schoolID' => $schoolID)), 'obj', 'teacherID');

					$sectionArray = [];
					$studentArray = [];
					$routineArray = [];
					$sectionArray = array('classesID' => $classID, 'schoolID' => $schoolID);
					$studentArray = array('srclassesID' => $classID, 'srschoolyearID' => $schoolyearID, 'srschoolID' => $schoolID);
					$routineArray = array('classesID' => $classID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID);
					if((int)$sectionID > 0) {
					...
					$postArray = array('classesID' => $classID, 'sectionID' => $sectionID, 'schoolyearID'=> $schoolyearID, 'schoolID' => $schoolID);
		...
		if(permissionChecker('classesreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$sectionArray = array('classesID' => $classID, 'schoolID' => $schoolID);
					$studentArray = array('srclassesID' => $classID, 'srschoolyearID' => $schoolyearID, 'srschoolID' => $schoolID);
					$routineArray = array('classesID' => $classID, 'schoolyearID' => $schoolyearID);
					if((int)$sectionID > 0) {
						$sectionArray['sectionID'] = $sectionID;
						$studentArray['srsectionID'] = $sectionID;
						$routineArray['sectionID'] = $sectionID;
