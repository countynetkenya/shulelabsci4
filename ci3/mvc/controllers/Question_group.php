...
class Question_group extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['groups'] = $this->question_group_m->get_order_by_question_group(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['group'] = $this->question_group_m->get_single_question_group(array('questionGroupID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['group']) {
                if($_POST) {
                    $rules = $this->rules();
                    $this->form_validation->set_rules($rules);
