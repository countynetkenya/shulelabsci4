		...
		if(permissionChecker('transactionreport')) {
			if($_POST) {
			    ...
			    exit;
					...
					$this->data['salarys'] = $this->make_payment_m->get_payment_salary_by_date(array('fromdate' => $this->input->post('fromdate'),'todate' => $this->input->post('todate'),'schoolID' => $schoolID));
