		...
		if(permissionChecker('admitcardreport')) {
			...
			if($_POST) {
			    ...
			    exit;
					...
					$exambyID   								= $this->exam_m->get_single_exam(array('examID'=>$examID, 'schoolID'=>$schoolID));
					$classes    								= $this->classes_m->general_get_order_by_classes(array('schoolID' => $schoolID));
					$sections   								= $this->section_m->general_get_order_by_section(array('schoolID' => $schoolID));
					$schoolyearbyID 						= $this->schoolyear_m->get_single_schoolyear(array('schoolyearID'=>$schoolyearID, 'schoolID'=>$schoolID));
