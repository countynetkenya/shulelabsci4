...
class Question_bank extends Api_Controller
{
    ...
    public function index_get()
    {
        ...
        $this->retdata['question_banks'] = $this->question_bank_m->get_order_by_question_bank(array('schoolID' => $schoolID));
        $this->retdata['groups']  = pluck($this->question_group_m->get_order_by_question_group(array('schoolID' => $schoolID)), 'obj', 'questionGroupID');
        $this->retdata['levels']  = pluck($this->question_level_m->get_order_by_question_level(array('schoolID' => $schoolID)), 'obj', 'questionLevelID');
        $this->retdata['types']   = pluck($this->question_type_m->get_order_by_question_type(array('schoolID' => $schoolID)), 'obj', 'typeNumber');
    ...
    /**
       * @OA\Get(
       *     path="/api/v10/question_bank/view/{questionBankID}",
       *     @OA\Parameter(
       *         name="questionBankID",
       *         description="",
       *         in = "path",
