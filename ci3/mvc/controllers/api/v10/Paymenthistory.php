...
class Paymenthistory extends Api_Controller
{
    ...
    public function index_get()
    {
        ...
        if($usertypeID == 3) {
            ...
            $this->retdata['payments'] = $this->payment_m->get_payment_with_studentrelation(array('schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
        }
