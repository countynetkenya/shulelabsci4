...
class Online_exam extends Api_Controller
{
    ...
    public function index_get()
    {
        ...
        $this->retdata['online_exams'] = $this->online_exam_m->get_order_by_online_exam(array('schoolYearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
