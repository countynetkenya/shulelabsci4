...
class Systemadmin extends Api_Controller
{
    ...
    {
        $this->retdata['systemadmins'] = $this->systemadmin_m->get_systemadmin_by_usertype(array('schoolID' => $this->session->userdata('schoolID')));
        $this->response([
            'status'    => true,
            'message'   => 'Success',
            'data'      => $this->retdata
    ...
    /**
       * @OA\Get(
       *     path="/api/v10/systemadmin/view/{systemadminID}",
       *     @OA\Parameter(
       *         name="systemadminID",
       *         description="",
       *         in = "path",
    ...
    {
        $this->retdata['usertypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $this->session->userdata('schoolID'))),'usertype','usertypeID');
    }
