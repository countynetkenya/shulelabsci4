...
class Routine extends Api_Controller
{
    ...
    public function index_get($id = null)
    {
        ...
        if((int)$id) {
            ...
            $routines   = $this->routine_m->get_order_by_routine(array('classesID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
            ...
            $teacher    = pluck($this->teacher_m->get_select_teacher(NULL, array('schoolID' => $schoolID)), 'obj', 'teacherID');
