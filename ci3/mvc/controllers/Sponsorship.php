 ...
 */
    ...
    {
        $this->data['sponsorships'] = $this->sponsorship_m->get_sponsorship_with_student(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function add()
    {
        ...
        $this->data['sponsors']   = $this->sponsor_m->get_order_by_sponsor(array('schoolID' => $schoolID));
        $this->data['candidates'] = $this->candidate_m->get_candidate_with_student(array('schoolID' => $schoolID));
        if ($_POST) {
            $rules = $this->rules();
            ...
            if ($this->form_validation->run() == false) {
                ...
                $candidate = $this->candidate_m->get_single_candidate(['candidateID' => $this->input->post('studentID'), 'schoolID' => $schoolID]);
                ...
                $sponsorship   = $this->sponsorship_m->get_single_sponsorship(['sponsorshipID' => $sponsorshipID, 'schoolID' => $schoolID]);
    ...
    public function edit()
    {
        ...
        if ((int) $sponsorshipID) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['sponsorship'] = $this->sponsorship_m->get_single_sponsorship(['sponsorshipID' => $sponsorshipID, 'schoolID' => $schoolID]);
        ...
        if (permissionChecker('sponsorship_add')) {
            ...
            if ((int) $sponsorshipID) {
                ...
                if (customCompute($sponsorship)) {
                    ...
                    $this->data['sponsors']    = $this->sponsor_m->get_single_sponsor(['sponsorID' => $sponsorship->sponsorID, 'schoolID' => $schoolID]);
                    $this->data['candidates'] = $this->candidate_m->get_candidate_with_student(['candidate.candidateID' => $sponsorship->candidateID, 'schoolID' => $schoolID]);
    ...
    public function delete()
    {
        $sponsorshipID = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $sponsorshipID) {
            $sponsorship = $this->sponsorship_m->get_single_sponsorship(['sponsorshipID' => $sponsorshipID, 'schoolID' => $this->session->userdata('schoolID')]);
            if (customCompute($sponsorship)) {
    ...
    public function getStudent()
    {
        ...
        $queryArray['srschoolID']     = $this->session->userdata('schoolID');
