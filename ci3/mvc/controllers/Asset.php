...
class Asset extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['assets'] = $this->asset_m->get_asset_with_category_and_location(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function attachUpload() {
        ...
        $asset = array();
        if((int)$id) {
            $asset = $this->asset_m->get_single_asset(array('assetID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
        }
    ...
    public function add() {
        ...
        $this->data['categories'] = $this->asset_category_m->get_order_by_asset_category(array('schoolID' => $schoolID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['asset'] = $this->asset_m->get_single_asset(array('assetID' => $id, 'schoolID' => $schoolID));
    ...
    public function view() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['asset'] = $this->asset_m->get_single_asset_with_category_and_location(array('assetID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['asset'] = $this->asset_m->get_single_asset(array('assetID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['asset']) {
    ...
    public function print_preview() {
        if(permissionChecker('asset_view')) {
            ...
            if((int)$assetID) {
                $this->data['asset'] = $this->asset_m->get_single_asset_with_category_and_location(array('assetID' => $assetID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function unique_serial() {
        ...
        $schoolID = $this->session->userdata('schoolID');
        if((int)$id) {
            $asset = $this->asset_m->get_single_asset(array("serial" => $this->input->post("serial"), "assetID !=" => $id, 'schoolID' => $schoolID));
            if(customCompute($asset)) {
            ...
            $asset = $this->asset_m->get_single_asset(array("serial" => $this->input->post("serial"), 'schoolID' => $schoolID));
