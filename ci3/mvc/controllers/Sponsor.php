...
class Sponsor extends Admin_Controller
{
    ...
    {
        $this->data['sponsors'] = $this->sponsor_m->get_order_by_sponsor(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function photoupload()
    {
        ...
        $user = [];
        if ((int) $id) {
            $user = $this->sponsor_m->get_single_sponsor(array('sponsorID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
        }
    ...
    public function view()
    {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $id) {
            $this->data['sponsor'] = $this->sponsor_m->get_single_sponsor(array('sponsorID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function print_preview()
    {
        if (permissionChecker('sponsor_view')) {
            ...
            if ((int) $sponsorID) {
                $this->data['sponsor'] = $this->sponsor_m->get_single_sponsor(array('sponsorID' => $sponsorID, 'schoolID' => $this->session->userdata('schoolID')));
