...
*/
	...
	public function index() {
		...
		$this->data['mailandsmstemplates'] = $this->mailandsmstemplate_m->get_order_by_mailandsmstemplate_with_usertypeID(array('schoolID' => $schoolID));
	...
	public function add() {
		...
		$schoolID = $this->session->userdata('schoolID');
		$usertypes = $this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID));
	...
	public function edit() {
		...
		if((int)$id) {
			$schoolID = $this->session->userdata('schoolID');
			$this->data['mailandsmstemplate'] = $this->mailandsmstemplate_m->get_single_mailandsmstemplate(array('mailandsmstemplateID' => $id, 'schoolID' => $schoolID));
