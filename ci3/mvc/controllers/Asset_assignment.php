...
class Asset_assignment extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['asset_assignments'] = $this->asset_assignment_m->get_asset_assignment_with_userypeID(array('asset_assignment.schoolID' => $this->session->userdata('schoolID')));
    ...
    public function add() {
        ...
        $this->data['locations'] = $this->location_m->get_order_by_location(array('schoolID' => $schoolID));
        $this->data['assets'] = $this->asset_m->get_order_by_asset(array('schoolID' => $schoolID));
        ...
        if($_POST) {
            ...
            if($this->input->post('usertypeID') == 3) {
                ...
                $this->data['sendClasses'] = $this->classes_m->get_order_by_classes(array('schoolID' => $schoolID));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['asset_assignment'] = $this->asset_assignment_m->get_single_asset_assignment(array('asset_assignmentID' => $id, 'schoolID' => $schoolID));
    ...
    public function view() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['asset_assignment'] = $this->asset_assignment_m->get_single_asset_assignment_with_usertypeID(array('asset_assignmentID' => $id, 'schoolID' => $schoolID));
            ...
            if(customCompute($this->data['asset_assignment'])) {
                ...
                if($usertypeID == 3) {
                    $student = $this->student_m->get_single_student(array('studentID' => $this->data['asset_assignment']->check_out_to, 'schoolID' => $schoolID));
            ...
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if((int)$asset_assignmentID) {
                        $this->data['asset_assignment'] = $this->asset_assignment_m->get_single_asset_assignment_with_usertypeID(array('asset_assignmentID' => $asset_assignmentID, 'schoolID' => $schoolID));
                        $this->data['usertypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)), 'usertype', 'usertypeID');
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['asset_assignment'] = $this->asset_assignment_m->get_single_asset_assignment(array('asset_assignmentID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['asset_assignment']) {
    ...
    public function valid_quantity($quantity) {
        ...
        if((int)$id) {
            $assigned_asset = $this->asset_assignment_m->get_asset_assignment(array('asset_assignmentID' => $id, 'schoolID' => $schoolID));
        }
        ...
        if($quantity && $assetID) {
            ...
            $assigned_quantity = 0;
            $balance_quantity = 0;
            $asset_purchases = $this->purchase_m->get_order_by_purchase(array('assetID' => $assetID, 'schoolID' => $schoolID));
            $asset_assigned = $this->asset_assignment_m->get_order_by_asset_assignment(array('assetID' => $assetID, 'status' => 1, 'schoolID' => $schoolID));
    ...
    public function quantity_number() {
        ...
        if( (int)$assetID) {
            $schoolID = $this->session->userdata('schoolID');
            $asset_purchases = $this->purchase_m->get_order_by_purchase(array('assetID' => $assetID, 'schoolID' => $schoolID));
            $asset_assigned = $this->asset_assignment_m->get_order_by_asset_assignment(array('assetID' => $assetID, 'status' => 0, 'schoolID' => $schoolID));
            if(customCompute($asset_purchases)) {
                foreach ($asset_purchases as $key => $purchase) {
    ...
    function allusers() {
        if($this->input->post('usertypeID') == 0) {
            ...
            if($usertypeID == 1) {
                ...
                $classes = $this->classes_m->get_order_by_classes(array('schoolID' => $schoolID));
    ...
    function allstudent() {
        ...
        if((int)$schoolyearID && (int)$classesID) {
            $students = $this->student_m->get_order_by_student(array('schoolyearID' => $schoolyearID, 'classesID' => $classesID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function allUsersArray($usertypeID, $classesID = 0) {
        ...
        if($usertypeID == 1) {
            ...
            $students = $this->student_m->get_order_by_student(array('classesID' => $classesID, 'schoolyearID' => $this->data['siteinfos']->school_year, 'schoolID' => $schoolID));
            if(customCompute($students)) {
                foreach ($students as $key => $student) {
