...
class Salary_template extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['salary_templates'] = $this->salary_template_m->get_order_by_salary_template(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit_ajax() {
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $schoolID = $this->session->userdata('schoolID');
                $salary_template = $this->salary_template_m->get_single_salary_template(array('salary_templateID' => $id, 'schoolID' => $schoolID));
                if(customCompute($salary_template)) {
                  $array = array(
                      "salary_grades"     => $this->input->post("salary_grades"),
                      "basic_salary"      => $this->input->post("basic_salary"),
                      "overtime_rate"     => $this->input->post("overtime_rate"),
    ...
    public function edit() {
        ...
        if((int)$id) {
            $schoolID = $this->session->userdata('schoolID');
            $this->data['salary_template'] = $this->salary_template_m->get_single_salary_template(array('salary_templateID' => $id, 'schoolID' => $schoolID));
            if($this->data['salary_template']) {
                $this->db->order_by("salary_optionID", "asc");
                $this->data['salaryoptions'] = $this->salaryoption_m->get_order_by_salaryoption(array('salary_templateID' => $id, 'schoolID' => $schoolID));
                $this->data['setid'] = $id;
    ...
    public function delete() {
        $id = htmlentities(escapeString($this->uri->segment(3)));
        if((int)$id) {
            $this->data['salary_template'] = $this->salary_template_m->get_single_salary_template(array('salary_templateID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
            if($this->data['salary_template']) {
    ...
    public function unique_salary_grades() {
        if($this->input->post('salary_grades')) {
            ...
            $schoolID = $this->session->userdata('schoolID');
            if((int)$id) {
                $salary_grades = $this->salary_template_m->get_single_salary_template(array('salary_grades' => $this->input->post("salary_grades"), 'salary_templateID !=' => $id, 'schoolID' => $schoolID));
                ...
                $salary_grades = $this->salary_template_m->get_single_salary_template(array('salary_grades' => $this->input->post("salary_grades"), 'schoolID' => $schoolID));
                if(customCompute($salary_grades)) {
                    $this->form_validation->set_message("unique_salary_grades", "%s already exists");
                    return FALSE;
                }
