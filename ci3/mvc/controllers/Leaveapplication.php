...
class Leaveapplication extends Admin_Controller
{
    ...
    */
    ...
    public function index() {
        ...
        if($usertypeID != 1) {
            $this->data['leaveapplications'] = $this->leaveapplication_m->get_order_by_leaveapplication(['applicationto_userID' => $userID, 'applicationto_usertypeID' => $usertypeID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID]);
        } else {
            $this->data['leaveapplications'] = $this->leaveapplication_m->get_order_by_leaveapplication(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
        }
        ...
        $this->data['allUser'] = getAllUserObjectWithStudentRelation(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID), TRUE);
        $this->data['allUserTypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)), 'usertype', 'usertypeID');
    ...
    public function status() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
            if(permissionChecker('leaveapplication')) {
                ...
                if ((int)$id) {
                    $schoolyearID      = $this->session->userdata("defaultschoolyearID");
                    $leaveapplication = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function view() {
        if(permissionChecker('leaveapplication')) {
            ...
            if ((int)$id) {
                ...
                $this->data['leaveapplication'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
                ...
                if(customCompute($this->data['leaveapplication'])) {
                    if((($this->data['leaveapplication']->applicationto_userID == $this->session->userdata('loginuserID')) && ($this->data['leaveapplication']->applicationto_usertypeID == $this->session->userdata('usertypeID'))) || ($this->session->userdata('usertypeID') == 1)) {
                        $leavecategory = $this->leavecategory_m->get_single_leavecategory(array('leavecategoryID' => $this->data['leaveapplication']->leavecategoryID, 'schoolID' => $schoolID));
                        ...
                        $leaveassign = $this->leaveassign_m->get_single_leaveassign(array('leavecategoryID' => $this->data['leaveapplication']->leavecategoryID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
            ...
            if($_POST) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if((int)$leaveapplicationID) {
                        ...
                        $schoolyearID  = $this->session->userdata("defaultschoolyearID");
                        $this->data['usertypes'] = pluck($this->usertype_m->get_order_by_usertype_with_or(array('schoolID' => $schoolID)),'usertype','usertypeID');
                        $this->data['leaveapplication'] = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $leaveapplicationID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function download() {
        ...
        if(permissionChecker('leaveapplication')) {
            ...
            if((int)$leaveapplicationID) {
                $leaveapplication = $this->leaveapplication_m->get_single_leaveapplication(array('leaveapplicationID' => $leaveapplicationID, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
                if(customCompute($leaveapplication)) {
