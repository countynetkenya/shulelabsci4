...
class Location extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        $this->data['locations'] = $this->location_m->get_order_by_location(array('schoolID' => $this->session->userdata('schoolID')));
    ...
    public function edit() {
        ...
        if((int)$id) {
            $this->data['location'] = $this->location_m->get_single_location(array('locationID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
