...
*/
	...
	public function fileupload() {
		...
		$income = array();
		if((int)$id) {
			$income = $this->income_m->get_single_income(array('incomeID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
		}
	...
	public function index() {
		...
		$this->data['alluser'] = getAllUserObjectWithStudentRelation(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
		$this->data['incomes'] = $this->income_m->get_order_by_income(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
	...
	public function edit() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) {
			...
			if($incomeID) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$this->data['income'] = $this->income_m->get_single_income(array('incomeID' => $incomeID, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
	...
	public function delete() {
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) {
			...
			if((int)$incomeID) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$income = $this->income_m->get_single_income(array('incomeID' => $incomeID, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
				if(customCompute($income)) {
	...
	public function download() {
		if(permissionChecker('income')) {
			...
			if((int)$id) {
				$schoolyearID = $this->session->userdata('defaultschoolyearID');
				$income = $this->income_m->get_single_income(array('incomeID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
				if(customCompute($income)) {
