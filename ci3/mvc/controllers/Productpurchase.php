...
class Productpurchase extends Admin_Controller {
    ...
    */
    ...
    public function index() {
        ...
        $this->data['productsuppliers'] = pluck($this->productsupplier_m->get_order_by_productsupplier(array('schoolID' => $schoolID)), 'productsuppliercompanyname', 'productsupplierID');
        $this->data['productpurchases'] = $this->productpurchase_m->get_order_by_productpurchase(array('schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
        $this->data['grandtotalandpaid'] = $this->grandtotalandpaid($this->data['productpurchases'], $schoolyearID, $schoolID);
    ...
    public function edit() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            if((int)$id) {
                ...
                $this->data['productpurchase'] = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
                ...
                $this->data['productpurchasepaid'] = $this->productpurchasepaid_m->get_productpurchasepaid_sum('productpurchasepaidamount', array('productpurchaseID' => $id, 'schoolID' => $schoolID));
                ...
                if($this->data['productpurchase']) {
                    if(($this->data['productpurchase']->productpurchaserefund == 0) && ($this->data['productpurchasepaid']->productpurchasepaidamount == NULL)) {
                        $this->data['productpurchaseitems'] = $this->productpurchaseitem_m->get_order_by_productpurchaseitem(array('schoolyearID' => $schoolyearID, 'productpurchaseID' => $id, 'schoolID' => $schoolID));
    ...
    public function view() {
        ...
        if((int)$id) {
            ...
            $this->data['productpurchaseitems'] = $this->productpurchaseitem_m->get_order_by_productpurchaseitem(array('productpurchaseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
    ...
    public function delete() {
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            if((int)$id) {
                $schoolyearID = $this->session->userdata('defaultschoolyearID');
                $this->data['productpurchase'] = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function download() {
        ...
        if(permissionChecker('productpurchase')) {
            $id = htmlentities(escapeString($this->uri->segment(3)));
            if((int)$id) {
                $productpurchase = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
    ...
    public function fileupload() {
        ...
        $productpurchase = [];
        if((int)$id && $id > 0) {
            $productpurchase = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $id, 'schoolID' => $this->session->userdata('schoolID')));
        }
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        if(permissionChecker('productpurchase_edit')) {
                            if($updateID > 0) {
                                ...
                                $this->productpurchaseitem_m->delete_productpurchaseitem_by_productpurchaseID(array('productpurchaseID' => $productpurchaseID, 'schoolID' => $schoolID));
                            } else {
                        ...
                        if(customCompute($productitems)) {
                            ...
                            if($updateID == 0) {
                                ...
                                $updatedata = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $updateID, 'schoolID' => $schoolID));
                        ...
                        if(permissionChecker('productpurchase_edit')) {
                            if($updateID > 0) {
                                $productpurchasepaid = $this->productpurchasepaid_m->get_productpurchasepaid_sum('productpurchasepaidamount', array('productpurchaseID' => $updateID, 'schoolID' => $schoolID));
    ...
    public function paymentlist() {
        ...
        if(!empty($productpurchaseID) && (int)$productpurchaseID && $productpurchaseID > 0) {
            ...
            if(customCompute($productpurchase)) {
                $productpurchasepaids = $this->productpurchasepaid_m->get_order_by_productpurchasepaid(array('productpurchaseID' => $productpurchaseID, 'schoolID' => $schoolID));
        ...
        if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('defaultschoolyearID') == 5)) {
            ...
            if(permissionChecker('productpurchase_delete')) {
                if((int)$productpurchasepaidID) {
                    $productpurchasepaid = $this->productpurchasepaid_m->get_single_productpurchasepaid(array('productpurchasepaidID' => $productpurchasepaidID, 'schoolID' => $schoolID));
    ...
    public function paymentfiledownload() {
        ...
        if(permissionChecker('productpurchase')) {
            $id = htmlentities(escapeString($this->uri->segment(3)));
            if((int)$id) {
                $productpurchasepaid = $this->productpurchasepaid_m->get_single_productpurchasepaid(array('productpurchasepaidID' => $id, 'schoolyearID' => $schoolyearID, 'schoolID' => $this->session->userdata('schoolID')));
            ...
            if(!empty($productpurchaseID) && (int)$productpurchaseID && $productpurchaseID > 0) {
                ...
                if(customCompute($productpurchase)) {
                    if($productpurchase->productpurchaserefund == 0 && $productpurchase->productpurchasestatus != 2) {
                        $productpurchaseitemsum = $this->productpurchaseitem_m->get_productpurchaseitem_sum(array('productpurchaseID' => $productpurchaseID, 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));
                        $productpurchasepaidsum = $this->productpurchasepaid_m->get_productpurchasepaid_sum('productpurchasepaidamount', array('productpurchaseID' => $productpurchaseID, 'schoolID' => $schoolID));
    ...
    public function saveproductpurchasepayment() {
        ...
        $retArray['status'] = FALSE;
        if(permissionChecker('productpurchase_add')) {
            $productpurchase = $this->productpurchase_m->get_single_productpurchase(array('productpurchaseID' => $this->input->post('productpurchaseID'), 'schoolID' => $schoolID));
                ...
                if($productpurchase->productpurchaserefund == 0 && $productpurchase->productpurchasestatus != 2) {
                    if($_POST) {
                        ...
                        if ($this->form_validation->run() == FALSE) {
                            ...
                            $productpurchaseitemsum = $this->productpurchaseitem_m->get_productpurchaseitem_sum(array('productpurchaseID' => $this->input->post('productpurchaseID'), 'schoolyearID' => $schoolyearID, 'schoolID' => $schoolID));

                            $productpurchasepaidsum = $this->productpurchasepaid_m->get_productpurchasepaid_sum('productpurchasepaidamount', array('productpurchaseID' => $this->input->post('productpurchaseID'), 'schoolID' => $schoolID));
