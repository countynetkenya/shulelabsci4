...
class Productsale extends Admin_Controller {
    ...
    */
    ...
    public function unique_productitemadjust() {
        $schoolID = $this->session->userdata('schoolID');
        $productpurchasequintity = pluck($this->productpurchaseitem_m->get_productpurchaseitem_quantity(array('schoolID' => $schoolID)), 'obj', 'productID');

        $productsalequintity = pluck($this->productsaleitem_m->get_productsaleitem_quantity(array('schoolID' => $schoolID)), 'obj', 'productID');

        $editID = $this->input->post('editID');
        if($editID > 0) {
            $productsalequintityforedit = pluck($this->productsaleitem_m->get_productsaleitem_quantity(array('productsaleitemID' => $editID, 'schoolID' => $schoolID)), 'obj', 'productID');
        }

        $productobj = pluck($this->product_m->get_order_by_product(array('schoolID' => $schoolID)), 'obj', 'productID');
        $productitems = json_decode($this->input->post('productitem'));
        $productAmountArray = [];
        if(customCompute($productitems)) {
            foreach ($productitems as $productitem) {
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        if(permissionChecker('productsale_edit')) {
                            if($updateID > 0) {
                                ...
                                $this->productsaleitem_m->delete_productsaleitem_by_productsaleID(array('productsaleID' => $productsaleID, 'schoolID' => $schoolID));
                            } else {
                        ...
                        if(($this->input->post('productsalepaymentstatusID') != 1) && ($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID'))) {
                            ...
                            $productsalepaidpaymentmethod = $paymenttype[$productsalepaidpaymentmethodID];
                            if($updateID == 0) {
                                if($this->input->post('productsalepaymentstatusID') > 1) {
                                    $productsalepaidamount = $this->input->post('productsalepaidamount');
                                    if(strtolower($productsalepaidpaymentmethod) == "mpesa" || strtolower($productsalepaidpaymentmethod) == "m-pesa") {
                                        $array['productsalestatus'] = 1;
                                    } elseif((float)$totalAmount == (float)$productsalepaidamount) {
                                        $array['productsalestatus'] = 3;
                                    ...
                                    $productsalepaidArray = array(
                                        ...
                                        'productsalepaidreferenceno' => $this->input->post("productsalepaidreferenceno"),
                                        'productsalepaidamount' => $this->input->post("productsalepaidamount"),
                                        'productsalepaidpaymentmethod' => $productsalepaidpaymentmethodID,
                                        'productsalepaidfile' => '',
                                    ...
                                    if($array['productsalestatus'] == 1) {
                                        $array = array('phonenumber' => $this->input->post("productsalepaidphone"), 'amount' => $this->input->post("productsalepaidamount"));
                                        ...
                                        if($response['ResponseCode'] === '0') {
                                            ...
                                            $productsalepaidID            = $this->db->insert_id();
                                            $mainmpesa['userID']          = $this->input->post("productsalecustomerID");
                                            $mainmpesa['usertypeID']      = $this->input->post("productsalecustomertypeID");
                                            $mainmpesa['schoolID']        = $schoolID;
                                    				$mainmpesa['schoolyearID']    = $this->session->userdata('defaultschoolyearID');
                                    				$mainmpesa['amount']          = $this->input->post("productsalepaidamount");
                                    				$mainmpesa['paymentdate']     = date('Y-m-d', strtotime($this->input->post("productsaledate")));
                                    				$mainmpesa['phonenumber']     = $this->input->post('productsalepaidphone');
                                            $mainmpesa['referencenumber'] = $productsaleID;
                                            $mainmpesa['module']          = 'productsale';
                                    				...
                                    				if($mainmpesaLastID) {
                                    						$mpesa = array(
                                                  'userID' => $this->input->post("productsalecustomerID"),
                                                  'usertypeID' => $this->input->post("productsalecustomertypeID"),
                                    							'amount' => $this->input->post("productsalepaidamount"),
                                            ...
                                            $retArray['error'] = array('mpesa' => $errorMessage);
                                            $retArray['status'] = FALSE;
                                            echo json_encode($retArray);
                                            exit;
                                        }
                                ...
                                $productsalepaid = $this->productsalepaid_m->get_productsalepaid_sum('productsalepaidamount', array('productsaleID' => $updateID, 'schoolID' => $schoolID));
                                unset($array['schoolyearID'], $array['create_date'], $array['create_userID'], $array['create_usertypeID']);
            ...
            if((int)$id) {
                ...
                if(customCompute($this->data['productsale'])) {
                    if(($this->data['productsale']->productsalerefund == 0) && ($this->data['productsalepaid']->productsalepaidamount == NULL)) {
                        ...
                        $this->productsaleitem_m->delete_productsaleitem_by_productsaleID(array('productsaleID' => $id, 'schoolID' => $schoolID));
                        $this->session->set_flashdata('success', $this->lang->line('menu_success'));
                        redirect(base_url("productsale/index"));
                    } else {
                        redirect(base_url("productsale/index"));
