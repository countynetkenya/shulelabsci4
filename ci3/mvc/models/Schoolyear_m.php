...
class Schoolyear_m extends MY_Model
{
	...
	public function get_schoolyear_where($array)
	{
		$where = '(schoolyear="'.$array['schoolyear'].'" AND schoolID="'.$array['schoolID'].'" AND (schoolyeartitle IS NULL OR schoolyeartitle = ""))';
		$this->db->select('*');
	...
	public function get_schoolyear_where_not($array, $id)
	{
		$where = '(schoolyear="'.$array['schoolyear'].'" AND schoolID="'.$array['schoolID'].'" AND schoolyearID !="'.$id.'" AND (schoolyeartitle IS NULL OR schoolyeartitle = ""))';
		$this->db->select('*');
		$this->db->from('schoolyear');
   	$this->db->where($where);
   	$query = $this->db->get();
	...
	public function get_obj_schoolyear($array = null)
	{
		$schoolyear = $this->get_single_schoolyear($array);
		$schoolyearArray = [];
