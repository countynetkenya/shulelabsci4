                ...
                <form role="form" method="post" enctype="multipart/form-data" id="productPurchaseDataForm">
                    <div class="productwarehouseDiv form-group <?=form_error('productwarehouseID') ? 'has-error' : '' ?>" >
                        <label for="productwarehouseID">
                            <?=$this->lang->line("productsale_warehouse")?> <span class="text-red">*</span>
                        </label>
                        <?php
                            $productwarehouseArray = array(0 => $this->lang->line("productsale_select_warehouse"));
                    ...
                    <div class="productsalecustomertypeDiv form-group <?=form_error('productsalecustomertypeID') ? 'has-error' : '' ?>" >
                        ...
                        <?php
                            ...
                            $usertypeArray['school'] = $this->lang->line("productsale_school");
                    ...
                    <table class="table table-bordered product-style" style="font-size: 16px;">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1" ><?=$this->lang->line('productsale_available')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('productsale_quantity')?></th>
                        ...
                        <tfoot id="productListFooter">
                            <tr>
                                <td colspan="4" style="font-weight: bold"><?=$this->lang->line('productsale_total')?></td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group productsalepaidpaymentmethodDiv <?=form_error('productsalepaidpaymentmethod') ? 'has-error' : '' ?>" >
                            ...
                            <?php
                                $paymentmethodArray = array('0' => $this->lang->line('productsale_select_paymentmethod'));
                    ...
                    <div class="col-sm-3" style="display:none">
                        <div class="form-group productsalepaidphoneDiv <?=form_error('productsalepaidphone') ? 'has-error' : '' ?>" >
                            <label for="productsalepaidphone" class="control-label">
                                <?=$this->lang->line("productsale_phone")?> <span class="text-red">*</span>
                            </label>
                            <input type="text" class="form-control" id="productsalepaidphone" name="productsalepaidphone" placeholder="254720000000" value="<?=set_value('productsalepaidphone')?>" >
                            <span class="control-label">
                                <?php echo form_error('productsalepaidphone'); ?>
                            </span>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function productItemDesign(productID, productText) {
        var usertypeID = $('#productsalecustomertypeID').val();
        ...
        if(typeof(productpurchasequintity) == 'object') {
            if(typeof(productpurchasequintity[productwarehouseID][productID]) == 'object') {
        ...
        if(typeof(productsalequintity) == 'object') {
            if(typeof(productsalequintity[productwarehouseID][productID]) == 'object') {
    ...
    $('#productsalepaidpaymentmethod').change(function() {
        var productsalepaidpaymentmethod = $("#productsalepaidpaymentmethod option:selected").text().toLowerCase();
        if(productsalepaidpaymentmethod == "mpesa" || productsalepaidpaymentmethod == "m-pesa") {
            $("#payment-box .col-sm-3").show();
            $("#payment-box .col-sm-4").slice(0,3).attr('class', 'col-sm-3');
        }
        else {
            $("#payment-box .col-sm-3:last").hide();
            $("#payment-box .col-sm-3").slice(0,3).attr('class', 'col-sm-4');
        }
    });
    ...
    $(document).on('click', '#addPurchaseButton', function() {
        ...
        if(parseInt($('#productsalepaymentstatusID').val()) > 1) {
            ...
            if($('#productsalepaidpaymentmethod').val() === '0') {
                ...
                if($('#productsalepaidpaymentmethod option:selected').text().toLowerCase() == "mpesa" || $('#productsalepaidpaymentmethod option:selected').text().toLowerCase() == "m-pesa") {
                    if($('#productsalepaidphone').val() === '') {
                        $('.productsalepaidphoneDiv').addClass('has-error');
                        error++;
                    } else {
                        $('.productsalepaidphoneDiv').removeClass('has-error');
                    }
                }
            }
        }
