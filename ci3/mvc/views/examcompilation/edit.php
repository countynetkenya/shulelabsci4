                ...
                <form role="form" method="post" enctype="multipart/form-data" id="examcompilationDataForm">
                  ...
                  <?php
                    ...
                    ?>
                        ...
                        <input type="text" class="form-control" id="examcompilation" name="examcompilation" value="<?=set_value('examcompilation', $examcompilation->examcompilation)?>" >
                    ...
                    <?php
                      ...
                      ?>
                        ...
                        <?php
                            ...
                            echo form_dropdown("compare_examID", $examsArray, set_value("compare_examID", $examcompilation->compare_examID), "id='compare_examID' class='form-control select2'");
                         ?>
                    </div>
                    ...
                    <?php
                      ...
                      ?>
                        ...
                        <?php
                            ...
                            echo form_dropdown("compare_examcompilationID", $examcompilationsArray, set_value("compare_examcompilationID", $examcompilation->compare_examcompilationID), "id='compare_examcompilationID' class='form-control select2'");
                         ?>
                    </div>
          					...
          					<div class="form-group">
          						...
          						<textarea id="note" name="note" class="form-control"><?=$examcompilation->note?></textarea>
          					</div>

                    <input id="editExamCompilationButton" type="button" class="btn btn-success" value="<?=$this->lang->line("update_examcompilation")?>" >
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_examcompilation')?></li>
                </ol>
            </div><!-- /.box-header -->
            <div class="box-body">
                    ...
                    <table class="table table-bordered feetype-style" style="font-size: 16px;">
                          ...
                          <?php
                              if(customCompute($examcompilation_exams)) {
                                  ...
                                  foreach ($examcompilation_exams as $examcompilation_exam) {
                                      ...
                                      $totalWeight += $examcompilation_exam->weight;

                                      echo '<tr id="tr_'.$randID.'" examID="'.$examcompilation_exam->examID.'">';
                                          echo '<td>';
                                              echo $i;
                                          echo '</td>';

                                          echo '<td>';
                                              echo isset($examcompilation_exam->exam) ? $examcompilation_exam->exam  : '';
                                          echo '</td>';

                                          echo '<td>';
                                              echo '<input type="text" class="form-control change-weight" id="td_weight_id_'.$randID.'" data-weight-id="'.$randID.'" value="'.$examcompilation_exam->weight.'">';
                                          echo '</td>';

                                          echo '<td>';
                                              echo '<a style="margin-top:3px" href="#" class="btn btn-danger btn-sm deleteBtn" id="exam_'.$randID.'" data-exam-id="'.$randID.'"><i class="fa fa-trash-o"></i></a>';
                                          echo '</td>';
                                      echo '</tr>';
                                      $i++;
                                  }
                        ...
                        <tfoot id="examListFooter">
                            <tr>
                                ...
                                <td id="totalWeight" style="font-weight: bold"><?=$totalWeight?></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#editExamCompilationButton', function() {
        var error=0;
        var field = {
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('examcompilation/edit/') . $examcompilationID?>",
            data: passData,
            async: true,
            dataType: "html",
