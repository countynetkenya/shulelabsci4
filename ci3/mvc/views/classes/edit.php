            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="classes_numeric" name="classes_code" value="<?=set_value('classes_code', $classes->classes_code);?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("divisionID", $array, set_value("divisionID", $classes->divisionID), "id='divisionID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
