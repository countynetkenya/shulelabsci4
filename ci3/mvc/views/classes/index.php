                    ...
                    <table id="example2" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-2"><?=$this->lang->line('classes_code')?></th>
								<th class="col-lg-2"><?=$this->lang->line('division')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($classes)) {$i = 1; foreach($classes as $class) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('classes_code')?>">
                                        <?php echo $class->classes_code; ?>
                                    </td>
									<td data-title="<?=$this->lang->line('division')?>">
                                        <?php echo $class->division; ?>
                                    </td>
