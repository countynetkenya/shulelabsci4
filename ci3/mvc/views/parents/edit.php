            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php $phoneArray = explode("/", str_replace(' ', '', $parents->phone));
                            foreach($phoneArray as $phone) {?>
                              <input type="number" class="form-control" name="phone[]" value="<?=set_value('phone', $phone)?>" placeholder="254720000000"> <br/>
                            <?php }?>

                            <input type="button" style="margin-top:3px; margin-bottom:10px" class="btn btn-primary btn-sm addPhoneBtn" value="Add" />
                        </div>
                        <span class="col-sm-4 control-label">
...
function productItemDesign() {
    text = '<input type="number" class="form-control" name="phone[]" value="" placeholder="720000000"> <br/>';
