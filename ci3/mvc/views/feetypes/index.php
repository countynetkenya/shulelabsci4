                    ...
                    <table id="example2" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-3"><?=$this->lang->line('feetypes_name')?></th>
                                <th class="col-sm-3"><?=$this->lang->line('feetypes_note')?></th>
                                <th class="col-sm-2"><?=$this->lang->line('feetypes_incomeaccount')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($feetypes)) {$i = 1; foreach($feetypes as $feetype) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('feetypes_incomeaccount')?>">
                                        <?php echo $feetype->incomeaccount; ?>
                                    </td>
