<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            $xml_preview_uri = base_url('studentmasterrecord/xlsx/'.$reportfor.'/'.$bloodID.'/'.$country.'/'.$transport.'/'.$hostel.'/'.$gender.'/'.$birthdaydatetime.'/'.$classesID.'/'.$sectionID);
                        ...
                        <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr>
									...
									<th><?=$this->lang->line('studentmasterrecord_guardian')?></th>
									<th><?=$this->lang->line('studentmasterrecord_admissiondate')?></th>
									<th><?=$this->lang->line('studentreport_birthdaydate')?></th>
									<th><?=$this->lang->line('studentreport_gender')?></th>
									<th><?=$this->lang->line('studentreport_blood_group')?></th>
									<th><?=$this->lang->line('studentmasterrecord_religion')?></th>
									<th><?=$this->lang->line('studentreport_email')?></th>
									<th><?=$this->lang->line('studentreport_phone')?></th>
									<th><?=$this->lang->line('studentmasterrecord_address')?></th>
									<th><?=$this->lang->line('studentmasterrecord_state')?></th>
									<th><?=$this->lang->line('studentreport_country')?></th>
									<?php if($classesID == 0) { ?>
                                        <th><?=$this->lang->line('studentreport_class')?></th>
                                    <?php } if($sectionID == 0 || $sectionID == '') { ?>
                                    <th><?=$this->lang->line('studentreport_section')?></th>
                                    <?php } ?>
									<th><?=$this->lang->line('studentmasterrecord_group')?></th>
									<th><?=$this->lang->line('studentmasterrecord_optional_subject')?></th>
                                    <th><?=$this->lang->line('studentreport_register')?></th>
									<th><?=$this->lang->line('studentmasterrecord_guardian')?></th>
									<th><?=$this->lang->line('studentmasterrecord_father_name')?></th>
									<th><?=$this->lang->line('studentmasterrecord_mother_name')?></th>
									<th><?=$this->lang->line('studentmasterrecord_father_profession')?></th>
									<th><?=$this->lang->line('studentmasterrecord_mother_profession')?></th>
									<th><?=$this->lang->line('studentreport_email')?></th>
									<th><?=$this->lang->line('studentreport_phone')?></th>
									<th><?=$this->lang->line('studentmasterrecord_address')?></th>
									<th><?=$this->lang->line('studentreport_photo')?></th>
									<th><?=$this->lang->line('studentmasterrecord_username')?></th>
									<!--<th><?=$this->lang->line('studentmasterrecord_password')?></th>-->
									<th><?=$this->lang->line('studentmasterrecord_balance')?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                ?>
                                    <tr>
										...
										<td data-title="<?=$this->lang->line('studentmasterrecord_guardian')?>">
                                            <?php echo $student->parent_name; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_admissiondate')?>">
                                            <?php echo $student->admission_date; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_birthdaydate')?>">
                                            <?php echo $student->dob; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_gender')?>">
                                            <?php echo $student->sex; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_blood_group')?>">
                                            <?php echo $student->bloodgroup; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_religion')?>">
										...
										<td data-title="<?=$this->lang->line('studentmasterrecord_address')?>">
                                            <?php echo $student->address; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_state')?>">
                                            <?php echo $student->state; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_country')?>">
                                        ...
                                        <?php } ?>
										<td data-title="<?=$this->lang->line('studentmasterrecord_group')?>">
                                            <?php echo $student->group; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_optional_subject')?>">
                                            <?php echo $student->sroptionalsubjectID; ?>
                                        </td>
                                        <td data-title="<?=$this->lang->line('studentreport_register')?>">
                                            <?php echo $student->srstudentID; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_guardian')?>">
                                            <?php echo $student->parent_name; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_father_name')?>">
                                            <?php echo $student->father_name; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_mother_name')?>">
                                            <?php echo $student->mother_name; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_father_profession')?>">
                                            <?php echo $student->father_profession; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_mother_profession')?>">
                                            <?php echo $student->mother_profession; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_email')?>">
										...
										<td data-title="<?=$this->lang->line('studentmasterrecord_address')?>">
                                            <?php echo $student->parent_address; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentreport_photo')?>">
                                            <?php echo $student->parent_photo; ?>
                                        </td>
										<td data-title="<?=$this->lang->line('studentmasterrecord_username')?>">
                                            <?php echo $student->parent_username; ?>
                                        </td>
										<!--<td data-title="<?=$this->lang->line('studentmasterrecord_password')?>">
                                            <?php echo $student->password; ?>
                                        </td>-->
										<td data-title="<?=$this->lang->line('studentmasterrecord_balance')?>">
