                    ...
                    <div class="col-sm-12">
                        <div id="hide-table">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th><?=$this->lang->line('balancefeesreport_student_detail')?></th>
                    										<th><?=$this->lang->line('balancefeesreport_class')?></th>
                    										<th><?=$this->lang->line('balancefeesreport_group')?></th>
                    										<th><?=$this->lang->line('balancefeesreport_balance_bf')?></th>
                                        <th><?=$this->lang->line('balancefeesreport_invoiced_amount')?></th>
                                        <th><?=$this->lang->line('balancefeesreport_less_credits')?> </th>
										                    <th><?=$this->lang->line('balancefeesreport_total_payable')?></th>
                                        <th><?=$this->lang->line('balancefeesreport_amount_paid')?></th>
                                        <th><?=$this->lang->line('balancefeesreport_balance_cf')?> </th>
                    										<th><?=$this->lang->line('balancefeesreport_%_unpaid')?> </th>
                    										<th><?=$this->lang->line('balancefeesreport_%_paid')?> </th>
                                        <th><?=$this->lang->line('balancefeesreport_%_credit') ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        foreach($students as $student) { ?>
                                            <tr>
                                                <td data-title="<?=$this->lang->line('balancefeesreport_student_detail')?>">
													<?=$student->srname?> - <?=$student->srstudentID?> - <?=$student->srclasses?> - <?=$student->group?>
                                                </td>
												<td data-title="<?=$this->lang->line('balancefeesreport_class')?>">
													<?=$student->srclasses?>
                                                </td>
												<td data-title="<?=$this->lang->line('balancefeesreport_group')?>">
													<?=$student->group?>
                                                </td>
                                                <td data-title="<?=$this->lang->line('balancefeesreport_balance_bf')?>">
                                                    <?php
                                                        $AmountBf = 0;
                                                        $CreditBf = 0;
                                                        $PaymentBf = 0;
                                                    ...
                                                    ?>
												                        ...
												                        <td data-title="<?=$this->lang->line('balancefeesreport_invoiced_amount')?>">
                                                    <?=isset($totalAmountAndDiscount[$student->srstudentID]['amount']) ? number_format($totalAmountAndDiscount[$student->srstudentID]['amount'],2) : number_format(0, 2)?>
                        												...
                        												<td data-title="<?=$this->lang->line('balancefeesreport_less_credits')?>">
                        													<?=isset($totalCredit[$student->srstudentID]['amount']) ? number_format($totalCredit[$student->srstudentID]['amount'],2) : number_format(0, 2)?>
                                                </td>
                        												<td data-title="<?=$this->lang->line('balancefeesreport_total_payable')?>">
													                             <?php
                                                        $Amount = 0;
                                                        $Credit = 0;
                                                        $Payment = 0;
                                                ...
                                                <td data-title="<?=$this->lang->line('balancefeesreport_total_paid')?>">
                                                ...
                                                <td data-title="<?=$this->lang->line('balancefeesreport_balance_cf')?>">
                                    ...
                                    ?>
								                ...
								                <tfoot>
                                        <td data-title="<?=$this->lang->line('balancefeesreport_grand_total')?>" class="text-right text-bold" colspan="3"><?=$this->lang->line('balancefeesreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?> </td>
                                        <td data-title="<?=$this->lang->line('balancefeesreport_total_balance_bf')?>" class="text-bold"><?=number_format($totalBalanceBf,2)?></td>
                                        <td data-title="<?=$this->lang->line('balancefeesreport_total_amount')?>" class="text-bold"><?=number_format($totalAmount,2)?></td>
										                    <td data-title="<?=$this->lang->line('balancefeesreport_total_credit')?>" class="text-bold"><?=number_format($totalCredits,2)?></td>
										                    <td data-title="<?=$this->lang->line('balancefeesreport_total_payable')?>" class="text-bold"><?=number_format($totalPayable,2)?></td>
                                        <td data-title="<?=$this->lang->line('balancefeesreport_total_paid')?>" class="text-bold"><?=number_format($totalPayments,2)?></td>
                                        <td data-title="<?=$this->lang->line('balancefeesreport_total_balance_cf')?>" class="text-bold"><?=number_format($totalBalanceCf,2)?></td>
                                        <td>
