                        ...
                        <div id="email" class="tab-pane <?php if($email == 1) echo 'active';?> ">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    ...
                                    <div id='divemail_use_parent_contact' class='form-group' style="display:none">
                                      <label for="use_parent_contact" class="col-sm-2 control-label">
                                          <?=$this->lang->line("mailandsms_use_parent_contact")?>
                                      </label>
                                      <div class="col-sm-6">
                                        <input type="checkbox" name="email_use_parent_contact" id="email_use_parent_contact">
                                      </div>
                                    </div>
                                        ...
                                        <?php
                                            if(form_error('email_attachment'))
                                                echo "<div class='form-group email_attachment has-error' >";
                                            else
                                                echo "<div class='form-group email_attachment' style='display:none'>";
                                        ?>
                                            <label for="email_attachment" class="col-sm-2 control-label">
                                                <?=$this->lang->line("mailandsms_attachment")?>
                                            </label>
                                            <div class="col-sm-4">
                                                <?php
                                                    $array = array('' => $this->lang->line('mailandsms_select_attachment'), 'student_statement' => $this->lang->line('mailandsms_student_statement'), 'exam_results' => $this->lang->line('mailandsms_exam_results'));

                                                    echo form_dropdown("email_attachment", $array, set_value("email_attachment"), "id='email_attachment' class='form-control select2'");
                                                ?>
                                            </div>
                                            <span class="col-sm-4 control-label">
                                                <?php echo form_error('email_attachment'); ?>
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <form class="form-horizontal" role="form" method="post">
                                        ...
                                        <?php
                                            if(form_error('sms_active'))
                                                echo "<div class='form-group has-error' >";
                                            else
                                                echo "<div class='form-group' >";
                                        ?>
                                            <label for="sms_active" class="col-sm-2 control-label">
                                                <?=$this->lang->line("mailandsms_status")?> <span class="text-red">*</span>
                                            </label>
                                            <div class="col-sm-6">
                                                <?php
                                                    $array = array(
                                                        '' => $this->lang->line('mailandsms_all'),
                                                        '1' => $this->lang->line('mailandsms_active'),
                                                        '0' => $this->lang->line('mailandsms_inactive')
                                                    );

                                                    echo form_dropdown("sms_active", $array, set_value("sms_active"), "id='sms_active' class='form-control select2'");
                                                ?>
                                            </div>
                                            <?php echo form_error('sms_active'); ?>
                                            <span class="col-sm-4 control-label">
                                            </span>
                                        </div>
                                        ...
                                        <div id='divsms_use_parent_contact' class='form-group' style="display:none">
                                          <label for="use_parent_contact" class="col-sm-2 control-label">
                                              <?=$this->lang->line("mailandsms_use_parent_contact")?>
                                          </label>
                                          <div class="col-sm-6">
                                            <input type="checkbox" name="sms_use_parent_contact" id="sms_use_parent_contact">
                                          </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6" >
                                                ...
                                                <?php
                                                    $array = array(
                                                        ...
                                                        //'bongasms' => $this->lang->line('mailandsms_bongasms'),
														                            'smsleopard' => $this->lang->line('mailandsms_smsleopard'),
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#email_message').jqte({change: function(){ $('#email_message').html($('.jqte_editor').html()); }
        });
        $('#otheremail_message').jqte({change: function(){ $('#otheremail_message').html($('#otheremail_message').closest('.jqte').find('.jqte_editor').html()); }
        });
        ...
        $("#email_usertypeID").change(function() {
            ...
            var userID = "<?=$setEmailUserID?>";
            if (usertypeID == 3) {
              $("#divemail_use_parent_contact").show();
            }
            else {
              $("#divemail_use_parent_contact").hide();
            }
            if(usertypeID != 'select') {
                ...
                if (usertypeID == "3" || usertypeID == "4") {
                  $(".email_attachment").show('slow');
                } else {
                  $(".email_attachment").hide('slow');
                }
            } else {
                $('#email_users').html('<?=$useroption?>');
                $(".email_attachment").hide('slow');
        ...
        $("#sms_usertypeID").change(function() {
            ...
            var userID = "<?=$setSMSUserID?>";
            if (usertypeID == 3) {
              $("#divsms_use_parent_contact").show();
            }
            else {
              $("#divsms_use_parent_contact").hide();
            }
            if(usertypeID != 'select') {
                $.ajax({
                    type: 'POST',
