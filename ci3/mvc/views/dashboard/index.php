<div class="row">
    ...
    <?php
		...
		<form action="" method="POST" style="margin:16px">
      <?php
          $array = array();
          $array[''] = $this->lang->line("select_division");
          foreach ($divisions as $division) {
              $array[$division->divisionsID] = $division->divisions;
          }
          echo form_dropdown("divisionID", $array, set_value("divisionID", $_POST['divisionID']), "id='divisionID' class='form-control select2' onchange='this.form.submit()'");
      ?>
		</form>

        <?php if(customCompute($generateBoxArray)) { foreach ($generateBoxArray as $generateBoxArrayKey => $generateBoxValue) { ?>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="small-box ">
            <a class="small-box-footer" style="background-color: #4169e1; color:#fff;" href="<?=base_url('balancefeesreport')?>">
                <div class="icon" style="padding: 9.5px 18px 6px 18px; background-color: #4169e1; color:#fff;">
