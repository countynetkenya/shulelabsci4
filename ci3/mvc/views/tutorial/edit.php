<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_tutorial')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('title') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title" value="<?=set_value('title', $tutorial->title)?>" >
                        </div>
                    ...
                    <div class="form-group <?=form_error('classesID') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                echo form_dropdown("classesID", $classArray, set_value("classesID", $tutorial->classesID), "id='classesID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('sectionID') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("sectionID", $sectionArray, set_value("sectionID", $tutorial->sectionID), "id='sectionID' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    <div class="form-group <?=form_error('subjectID') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("subjectID", $subjectArray, set_value("subjectID", $tutorial->subjectID), "id='subjectID' class='form-control select2'");
                            ?>   
                        </div>
                    ...
                    <div class="form-group <?=form_error('is_public') ? 'has-error' : ''?>">
                        ...
                        <div class="col-sm-6">
                            <input type="checkbox" name="is_public" <?=$tutorial->is_public==0 ? 'checked' : ''?>/>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_tutorial")?>" >
                        </div>
                    </div>
                </form>
            </div>
