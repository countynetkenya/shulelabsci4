    ...
    <div class="col-sm-4">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><i class="fa fa-edit"></i> <?=$this->lang->line('edit')?></h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                        ...
                        <input type="text" name="title" class="form-control" id="title" value="<?=set_value('title', $lesson->title)?>">
                        <span class="text-red">
                            <?=form_error('title')?>
                        </span>
                    </div>
                    ...
                    <div class="form-group <?=form_error('lesson_provider') ? 'has-error' : '' ?>">
                        <label for="lesson_provider"><?=$this->lang->line('tutorial_lesson_provider')?> <span class="text-red">*</span></label>
                        <?php
                        ...
                        echo form_dropdown("lesson_provider", $lessonProviderArray, set_value("lesson_provider", $lesson->lesson_provider), "id='lesson_provider' class='form-control'");
                        ?>
                        <span class="text-red">
                    ...
                    <div class="form-group <?=form_error('video_url') ? 'has-error' : '' ?>">
                        ...
                        <input type="text" name="video_url" class="form-control" id="video_url" value="<?=set_value('video_url', htmlspecialchars_decode($lesson->video_url))?>">
                        <span class="text-red">
                    ...
                    <div class="form-group <?=form_error('duration') ? 'has-error' : '' ?>">
                        ...
                        <input type="text" name="duration" class="form-control" id="duration" value="<?=set_value('duration', $lesson->duration)?>">
                        <span class="text-red">
                            <?=form_error('duration')?>
                        </span>
                    </div>
                    ...
                    <div class="form-group <?=form_error('description') ? 'has-error' : '' ?>">
                        ...
                        <textarea class="form-control" name="description" id="description" cols="30" rows="5"><?=set_value('description', $lesson->description)?></textarea>
                        <span class="text-red">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?=$this->lang->line('menu_edit')?></li>
                </ol>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div id="hide-table">
