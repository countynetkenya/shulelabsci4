<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_examranking')?></li>
        </ol>
    </div><!-- /.box-header -->
    ...
    <div class="box-body">
        ...
        <form class="form-horizontal" role="form" method="post">
            ...
            ?>
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="examranking" name="examranking" value="<?=set_value('examranking')?>" >
                </div>
            ...
            <fieldset class="setting-fieldset">
                ...
                echo form_dropdown("mandatoryTopNumber", $mandatoryTopNumberArray, set_value("mandatoryTopNumber", $examranking->mandatory_top), "id='mandatoryTopNumber' class='form-control' style='width:auto' title='Select the top number of subjects to be used in ranking'");?>
                <br/>
                <div class="row">
                    <?php
                                ...
                                echo '<div class="col-sm-3">';
                                    echo '<div class="checkbox">';
                                        echo '<label>';
                                            ...
                                            echo '<input class="globalexam" type="checkbox" value="'.$mandatorySubject->subjectID.'" name="subjects[]"> &nbsp;';
          ...
          <fieldset class="setting-fieldset">
              ...
              echo form_dropdown("optionalTopNumber", $optionalTopNumberArray, set_value("optionalTopNumber", $examranking->optional_top), "id='optionalTopNumber' class='form-control' style='width:auto' title='Select the top number of subjects to be used in ranking'");?>
              <br/>
              <div class="row">
                  <?php
                      if(customCompute($optionalSubjects)) {
                          foreach ($optionalSubjects as $optionalSubject) {
                              ...
                              echo '<div class="col-sm-3">';
                                  echo '<div class="checkbox">';
                                      echo '<label>';
                                          //echo '<input class="globalexam" type="checkbox" value="0_'.$exam->examID.'" '.set_checkbox('exams[]', '0_'.$exam->examID, $checkbox).' name="exams[]"> &nbsp;';
                                          echo '<input class="globalexam" type="checkbox" value="'.$optionalSubject->subjectID.'" name="subjects[]"> &nbsp;';
                        ...
                        foreach ($nonexaminableSubjects as $nonexaminableSubject) {
                            ...
                            echo '<div class="col-sm-3">';
                                echo '<div class="checkbox">';
                                    echo '<label>';
                                        //echo '<input class="globalexam" type="checkbox" value="0_'.$exam->examID.'" '.set_checkbox('exams[]', '0_'.$exam->examID, $checkbox).' name="exams[]"> &nbsp;';
                                        echo '<input class="globalexam" type="checkbox" value="'.$nonexaminableSubject->subjectID.'" name="subjects[]"> &nbsp;';
      ...
      if(customCompute($mandatorySubjects) || customCompute($optionalSubjects) || customCompute($nonexaminableSubjects)){?>
            <div class="row">
                <div class="col-sm-12">
                    <input type="submit" class="btn btn-success btn-md" value="<?=$this->lang->line("add_examranking")?>" >
                </div>
            </div>
        </form>
      <?php }?>
