                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if((permissionChecker('teacher_add') && permissionChecker('teacher_delete')) || ($this->session->userdata('usertypeID') == $profile->usertypeID && $this->session->userdata('loginuserID') == $profile->teacherID)) {  ?>
                            ...
                            <li><a href="#exam" data-toggle="tab"><?=$this->lang->line('teacher_exam')?></a></li>
                        <?php } ?>
                    </ul>
...
<?php
$this->load->view("teacher/SubjectPerformanceChartJavascript.php");
$this->load->view("teacher/ExamPerformanceChartJavascript.php");
$this->load->view("teacher/PositionPerformanceChartJavascript.php");
} ?>
