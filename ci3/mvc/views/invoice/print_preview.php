...
<body>
  	<div>
	        	...
	        	<td width="33%">
	            	<table >
	              		<tbody>
			                ...
			                <tr>
			                    <td><?php  echo $this->lang->line("student_registerNO"). " : ". $maininvoice->srstudentID; ?></td>
			                </tr>
	    ...
	    <table class="table table-bordered">
	      	...
	      	<tfoot>
	          	<tr>
	              	<td class="pull-right" colspan="2"><b><?=$this->lang->line('invoice_totalamount')?> <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></b></td>
	        ...
	        <tr>
	            <td width="35%">
					<table>
	                    ...
	                    <tr>
	                        <td><?=$maininvoice->maininvoicememo?></td>
	                    </tr>
	                </table>
	            </td>
				<td width="30%">
