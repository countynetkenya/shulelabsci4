    		...
    		<div class="row invoice-info">
    		    ...
    		    <div class="col-sm-4 invoice-col" style="font-size: 16px;">
    	        	...
    	        	<address >
    	        		...
    	        		<!--<?=$this->lang->line("invoice_roll"). " : ". $maininvoice->srstudentID?><br>-->
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <table class="table table-bordered product-style">
                                ...
                                <?php $subtotal = 0; $totalsubtotal = 0; $i = 1; if(customCompute($invoices)) { foreach($invoices as $invoice) { $discount = 0; if($invoice->discount > 0) { $discount = (($invoice->amount/100) * $invoice->discount); } $subtotal = ($invoice->amount - $discount); $totalsubtotal += $subtotal; ?>
                                    <tr>
                                        ...
                                        <td data-title="<?=$this->lang->line('invoice_feetype')?>">
                                            ...
                                            <?=isset($bundlefeetypes[$invoice->bundlefeetypeID]) ? $bundlefeetypes[$invoice->bundlefeetypeID] : ''?>
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2"><span class="pull-right"><b><?=$this->lang->line('invoice_totalamount')?> <?=!empty($siteinfos->currency_code) ? '('.$siteinfos->currency_code.')' : ''?></b></span></td>
