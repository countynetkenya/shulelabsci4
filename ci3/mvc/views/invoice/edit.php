            ...
            <div class="box-body">
                <form role="form" method="post" enctype="multipart/form-data" id="invoiceDataForm">
					...
					<div class="form-group <?=form_error('schooltermID') ? 'has-error' : '' ?>" >
                        <label for="schooltermID">
                            ...
                            <?php
                                ...
                                echo form_dropdown("schooltermID", $termsArray, set_value("schooltermID", $maininvoice->maininvoiceschooltermID), "id='schooltermID' class='form-control select2'");
                            ?>
                        <span class="text-red">
					...
					<div class="form-group">
						...
						<textarea id="memo" name="memo" class="form-control"><?=$maininvoice->maininvoicememo?></textarea>
					</div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group <?=form_error('bundlefeetypeID') ? 'has-error' : '' ?>" >
                                ...
                                <?php
                                    /*$bundlefeetypeArray = array('' => $this->lang->line("invoice_select_bundlefeetype"));
                                    foreach ($bundlefeetypes as $bundlefeetype) {
                                        $bundlefeetypeArray[$bundlefeetype->bundlefeetypesID] = $bundlefeetype->bundlefeetypes;
                                    }
                                    echo form_dropdown("bundlefeetypeID", $bundlefeetypeArray, set_value("bundlefeetypeID"), "id='bundlefeetypeID' class='form-control select2'");*/
                                ?>
                            ...
                            <?php
                                if(customCompute($invoices)) {
                                    ...
                                    foreach ($invoices as $invoice) {
                                        ...
                                        echo '<tr id="tr_'.$randID.'" invoicefeetypeID="'.$invoice->feetypeID.'" invoicebundlefeetypeID="'.$invoice->bundlefeetypeID.'">';
                                            echo '<td>';
                                                echo $i;
                                            echo '</td>';
                                            ...
                                            echo '<td>';
                                                ...
                                                echo isset($bundlefeetypes[$invoice->bundlefeetypeID]) ? $bundlefeetypes[$invoice->bundlefeetypeID]->bundlefeetypes  : '';
                                            echo '</td>';

                                            echo '<td>';
                                                if (isset($bundlefeetypes[$invoice->bundlefeetypeID]))
                                                    echo '<input type="text" class="form-control change-amount" readonly id="td_amount_id_'.$randID.'" data-amount-id="'.$randID.'" value="'.$invoice->amount.'">';
                                                else
