...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_schoolterm')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php 
                        if(form_error('schooltermtitle')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="schooltermtitle" class="col-sm-2 control-label">
                            <?=$this->lang->line("schoolterm_schooltermtitle")?>
							<span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="schooltermtitle" name="schooltermtitle" value="<?=set_value('schooltermtitle')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_schoolterm")?>" >
                        </div>
                    </div>
