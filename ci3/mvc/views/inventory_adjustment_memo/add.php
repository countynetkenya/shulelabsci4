        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("inventory_adjustment_memo/index")?>"><?=$this->lang->line('menu_inventory_adjustment_memo')?></a></li>
                    <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_inventory_adjustment_memo')?></li>
                </ol>
            </div><!-- /.box-header -->
            <div class="box-body">
    ...
    $(document).on('click', '.deleteBtn', function(er) {
      ...
      $(document).on('click', '#adjustStockButton', function() {
        ...
        function ajaxCall(passData) {
            $.ajax({
                type: 'POST',
                url: "<?=base_url('inventory_adjustment_memo/saveadjustment')?>",
                data: passData,
                async: true,
                dataType: "html",
        ...
        function errrorLoader(response) {
            if(response.status) {
                window.location = "<?=base_url("inventory_adjustment_memo/index")?>";
            } else {
