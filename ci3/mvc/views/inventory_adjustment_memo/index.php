        ...
        <div class="row">
            <div class="col-sm-12">
              <h5 class="page-header">
                <?php if(permissionChecker('inventory_adjustment_memo_add')) { ?>
                    <a href="<?php echo base_url('inventory_adjustment_memo/add') ?>">
                        <i class="fa fa-adjust"></i>
                        <?=$this->lang->line('adjust_title')?>
                    </a>
                <?php }?>
              </h5>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-3"><?=$this->lang->line('stock_warehouse')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('stock_quantity')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('stock_memo')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($mainstocks)) {$i = 1; foreach($mainstocks as $mainstock) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('stock_memo')?>">
                                        <?=$mainstock->memo;?>
                                    </td>
                                    ...
                                    <td>
                                      <?php if(permissionChecker('inventory_adjustment_memo_view')) {
                                        echo btn_view('inventory_adjustment_memo/view/'.$mainstock->mainstockID, $this->lang->line('view'));
                                      } ?>
                                    </td>
                                </tr>
                            <?php $i++; }} ?>
