                ...
                <form role="form" method="post" enctype="multipart/form-data" id="bundlefeetypeDataForm">
                  ...
                  <?php
                    ...
                    ?>
                        ...
                        <input type="text" class="form-control" id="bundlefeetypes" name="bundlefeetypes" value="<?=set_value('bundlefeetypes')?>" >
                    ...
                    <input id="addBundleFeeTypeButton" type="button" class="btn btn-success" value="<?=$this->lang->line("add_feetype")?>" >
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_bundlefeetypes')?></li>
                </ol>
            </div><!-- /.box-header -->
            <div class="box-body">
...
<script type="text/javascript">
    ...
    function productItemDesign(feetypeID, productText) {
        ...
        var text = '<tr id="tr_'+randID+'" feetypeID="'+feetypeID+'">';
            text += '<td>';
                text += lastTdNumber;
            text += '</td>';
...
<script type="text/javascript">
    ...
    $(document).on('click', '#addBundleFeeTypeButton', function() {
        ...
        var feetypeitems = $('tr[id^=tr_]').map(function(){
            ...
            return { feetypeID : $(this).attr('feetypeid'), amount: $(this).children().eq(2).children().val()};
        }).get();
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('bundlefeetypes/add')?>",
            data: passData,
            async: true,
            dataType: "html",
