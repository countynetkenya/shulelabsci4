                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("usertypeID", $array,
                                    set_value("usertypeID", $user->usertypeID), "id='usertypeID' class='form-control select2'"
                                );
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="schoolID" class="col-sm-2 control-label">
                            <?=$this->lang->line("user_schoolID")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                          <?php
                          $schoolIDArray = [];
                          ...
                          echo form_dropdown("schoolID[]", $schoolIDArray, set_value("schoolID", explode(",", $user->schoolID)), "id='schoolID' class='form-control select2' multiple");
                          ?>
                        </div>
                         <span class="col-sm-4 control-label">
