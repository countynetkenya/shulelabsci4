		      		...
		      		<div class="box-body box-profile">
		              	...
		              	<ul class="list-group list-group-unbordered">
		              		<li class="list-group-item" style="background-color: #FFF">
		                    	<b><?=$this->lang->line('student_registerNO')?></b> <a class="pull-right"><?=$profile->srstudentID?></a>
		                  	</li>
		                  	<!--<li class="list-group-item" style="background-color: #FFF">
			              		...
			              		<div id="hide-table">
				                    <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		...
						              		<tr>
				                                <td colspan="2" data-title="<?=$this->lang->line('student_total')?>">
				                                	<?php if($siteinfos->currency_code) { echo '<b>'. $this->lang->line('student_total').' ('.$siteinfos->currency_code.')'. '</b>'; } else { echo '<b>'. $this->lang->line('student_total') . '</b>'; }
				                                    ?>
				                                </td>
				                                <td data-title="<?=$this->lang->line('student_total')?> <?=$this->lang->line('student_paid')?>">
...
<?php
$this->load->view("student/SubjectPerformanceChartJavascript.php");
$this->load->view("student/ExamPerformanceChartJavascript.php");
$this->load->view("student/PositionPerformanceChartJavascript.php");
} ?>
