                    ...
                    <h5 class="page-header">
                        <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) { ?>
                            <?php if(permissionChecker('student_add')) { ?>
                                ...
                                &nbsp&nbsp
                                <a href="<?php echo base_url('student/import') ?>">
                                    <i class="fa fa-plus"></i>
                                    <?=$this->lang->line('import_title')?>
                                </a>
                            <?php } ?>
                        <?php } ?>

                        <?php if ($config['active'] == "1" && $usertypeID == 1) {
                                    ...
                                    <table id="example2" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-sm-2"><?=$this->lang->line('parent_guargian_name')?></th>
                                                <th class="col-sm-2"><?=$this->lang->line('parent_phone')?></th>
                                                <th class="col-sm-2"><?=$this->lang->line('parent_email')?></th>
                                        ...
                                        <tbody>
                                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { ?>
                                                <tr>
                                                    ...
                                                    <td data-title="<?=$this->lang->line('parent_guargian_name')?>">
                                                        <a target="_blank" href="<?=base_url('parents/edit/')?><?=$student->parentID?>"><?php echo $student->parent_name; ?></a>
                                                    </td>
                                                    <td data-title="<?=$this->lang->line('parent_phone')?>">
                                                        <?php echo $student->parent_phone; ?>
                                                    </td>
                                                    <td data-title="<?=$this->lang->line('parent_email')?>">
