                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?=form_error('optionalSubjectID') ? ' has-error' : ''  ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("optionalSubjectID[]", $optionalSubjectArray, set_value("optionalSubjectID", explode(",", $student->sroptionalsubjectID)), "id='optionalSubjectID' class='form-control select2' multiple");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('nonexaminableSubjectID') ? ' has-error' : ''  ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("nonexaminableSubjectID[]", $nonexaminableSubjectArray, set_value("nonexaminableSubjectID", explode(",", $student->srnonexaminablesubjectID)), "id='nonexaminableSubjectID' class='form-control select2' multiple");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
