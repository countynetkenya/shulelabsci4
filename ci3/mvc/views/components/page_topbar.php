                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-body">
                                    ...
                                    if($this->session->userdata('usertypeID') == 1 || ($this->session->userdata('usertypeID') >= 5 && $this->session->userdata('usertypeID') <= 8)) {
                                      if(customCompute($schools) > 1) {
                                        $switch = true;
                                      }
                                    }?>
                                    <div class="<?= ($switch) ? 'col-xs-4' : 'col-xs-6' ?> text-center">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a href="<?=base_url("school/select")?>">
                                            <div><i class="fa fa-institution"></i></div>
                                            <?=$this->lang->line("switch")?>
                                        </a>
                                    </div>
                                    <?php }?>
                                    <div class="<?= ($switch) ? 'col-xs-4' : 'col-xs-6' ?> text-center">
