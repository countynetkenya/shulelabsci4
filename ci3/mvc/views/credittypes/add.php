...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_credittypes')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        <label for="credittypes" class="col-sm-2 control-label">
                            <?=$this->lang->line("credittypes_name")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="credittypes" name="credittypes" value="<?=set_value('credittypes')?>" >
                        </div>
                    ...
                    ?>
                        <label for="monthly" class="col-sm-2 control-label">
                            <?=$this->lang->line("credittypes_monthly")?>
                        </label>
                        <div class="col-sm-6">
                  ...
                  <?php } elseif (now() > $config['sessionAccessTokenExpiry']) {?>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-8">
                        <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_credittype")?>" >
                      </div>
                    </div>
