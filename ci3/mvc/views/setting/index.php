    ...
    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <fieldset class="setting-fieldset">
                <legend class="setting-legend"><?=$this->lang->line('setting_school_configaration')?></legend>
                <?php if($this->session->userdata('usertypeID') == 0) {?>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('sname') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="sname"><?=$this->lang->line("setting_system_name")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="set your school title here"></i>
                                </label>
                        ...
                        <div class="col-sm-12">
                            ...
                            <?php
                                $array = array(
                                    ...
                                    "smsleopard" => $this->lang->line("setting_smsleopard"),
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend"><?=$this->lang->line('setting_fees_balance_notification')?></legend>
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('fees_balance_notification')) { echo 'has-error'; } ?>">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line("setting_fees_balance_notification")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Select Fees Balance Notification"></i>
                            </label>
                            <?php
                                $feesBalanceArray[0] = $this->lang->line('setting_enable');
                                $feesBalanceArray[1] = $this->lang->line('setting_disable');

                                echo form_dropdown("fees_balance_notification", $feesBalanceArray, set_value("fees_balance_notification",$setting->fees_balance_notification), "id='fees_balance_notification' class='form-control select2'");
                            ?>
                            <span class="control-label">
                                <?php echo form_error('fees_balance_notification'); ?>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend"><?=$this->lang->line('setting_inventory_settings')?></legend>
                <div class="col-sm-4">
                    <div class="form-group <?=form_error('inventory_allow_negative_stock') ? 'has-error' : ''?>">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line('setting_inventory_allow_negative_stock')?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="<?=$this->lang->line('setting_inventory_allow_negative_stock_help')?>"></i>
                            </label>
                            <?php
                                $inventoryAllowNegativeOptions = [
                                    '0' => $this->lang->line('setting_disable'),
                                    '1' => $this->lang->line('setting_enable'),
                                ];
                                echo form_dropdown(
                                    "inventory_allow_negative_stock",
                                    $inventoryAllowNegativeOptions,
                                    set_value("inventory_allow_negative_stock", isset($setting->inventory_allow_negative_stock) ? $setting->inventory_allow_negative_stock : 0),
                                    "id='inventory_allow_negative_stock' class='form-control select2'"
                                );
                            ?>
                            <span class="control-label">
                                <?=form_error('inventory_allow_negative_stock'); ?>
                            </span>
                        </div>
                    </div>
                </div>
