...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("superadmin/users/index")?>"><?=$this->lang->line('menu_superadmin_users')?></a></li>
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_superadmin_users')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        if(form_error('schoolID'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="schoolID" class="col-sm-2 control-label">
                            <?=$this->lang->line("systemadmin_schoolID")?>
                        </label>
                        <div class="col-sm-6">
                          <?php
                          $schoolIDArray = [];
                          if(customCompute($schools)) {
                              foreach ($schools as $school) {
                                  $schoolIDArray[$school->schoolID] = $school->name;
                              }
                          }
                          echo form_dropdown("schoolID[]", $schoolIDArray, set_value("schoolID", explode(",", $systemadmin->schoolID)), "id='schoolID' class='form-control select2' multiple");
                          ?>
                        </div>
                         <span class="col-sm-4 control-label">
                            <?php echo form_error('schoolID'); ?>
                        </span>
                    </div>
