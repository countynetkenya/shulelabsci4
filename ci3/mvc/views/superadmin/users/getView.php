<?php if(customCompute($profile)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php
                 echo btn_add_pdf('admin/print_preview/'.$profile->systemadminID, $this->lang->line('pdf_preview'))
                ?>

                <?php if(permissionChecker('admin_edit')) { echo btn_sm_edit('admin/edit/'.$profile->systemadminID, $this->lang->line('edit')); }
                ?>
    ...
    <form class="form-horizontal" role="form" action="<?=base_url('superadmin/users/send_mail');?>" method="post">
