...
<div class="well">
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php
             echo btn_add_pdf('admin/print_preview/'.$systemadmin->systemadminID, $this->lang->line('pdf_preview'))
            ?>

            <?php if(permissionChecker('admin_edit')) { echo btn_sm_edit('admin/edit/'.$systemadmin->systemadminID, $this->lang->line('edit')); }
            ?>
...
<script language="javascript" type="text/javascript">
    ...
    $(document).on('click','#send_pdf', function() {
        ...
        if(error == 0) {
            $.ajax({
                type: 'POST',
                url: "<?=base_url('superadmin/users/send_mail')?>",
