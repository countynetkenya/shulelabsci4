        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('is_billable_default') ? 'has-error' : '' ?>">
                        <label for="is_billable_default" class="col-sm-2 control-label">
                            <?=$this->lang->line('product_is_billable_default')?>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $billingOptions = [
                                    '1' => $this->lang->line('product_billable'),
                                    '0' => $this->lang->line('product_non_billable'),
                                ];
                                echo form_dropdown('is_billable_default', $billingOptions, set_value('is_billable_default', (string) $product->is_billable_default), "id='is_billable_default' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('is_billable_default'); ?>
                        </span>
                    </div>
