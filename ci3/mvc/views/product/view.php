<?php if(customCompute($product)) { ?>
                        ...
                        <table class="table table-bordered product-style">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-lg-2"><?=$this->lang->line('product_is_billable_default')?></th>
    ...
    <script>
        window.PRODUCT_ID = <?= (int) $product->productID ?>;
        window.PRODUCT_MOVEMENT_DEFAULT_RANGE = {
...
<div id="movementChart" style="margin-top:18px"></div>
<script src="/public/js/product_view.js"></script>
<script>
  (function(){
    try {
      var productId = window.PRODUCT_ID || 0;
      var defaultRange = window.PRODUCT_MOVEMENT_DEFAULT_RANGE || null;
      if(productId && typeof window.renderMovementChart === "function"){
        window.renderMovementChart(productId, defaultRange);
      }
