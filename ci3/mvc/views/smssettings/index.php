                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
							              <li class="<?php if($smsleopard == 1) echo 'active'; ?>"><a data-toggle="tab" href="#smsleopard" aria-expanded="true">SMSLeopard</a></li>
                            <li class="<?php if($bongasms == 1) echo 'active'; ?>"><a data-toggle="tab" href="#bongasms" aria-expanded="true">BongaSMS</a></li>
                        ...
                        <div class="tab-content">
							<div id="smsleopard" class="tab-pane <?php if($smsleopard == 1) echo 'active';?> ">
                                <br>
                                <div class="row">
                                    <div class="col-sm-10">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            <?php echo form_hidden('type', 'smsleopard'); ?>
											<?php
                                                if(form_error('smsleopard_senderID'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="smsleopard_senderID" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_senderID")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_smsleopard)): ?>
                                                    <input type="text" class="form-control" id="smsleopard_senderID" name="smsleopard_senderID" value="<?=set_value('smsleopard_senderID')?>" >
                                                  <?php else: ?>
                                                    <input type="text" class="form-control" id="smsleopard_senderID" name="smsleopard_senderID" value="<?=set_value('smsleopard_senderID', $set_smsleopard['smsleopard_senderID'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('smsleopard_senderID'); ?>
                                                </span>
                                            </div>

                                            <?php
                                                if(form_error('smsleopard_accountID'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="smsleopard_accountID" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_accountID")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_smsleopard)): ?>
                                                    <input type="text" class="form-control" id="smsleopard_accountID" name="smsleopard_accountID" value="<?=set_value('smsleopard_accountID')?>" >
                                                  <?php else: ?>
                                                    <input type="text" class="form-control" id="smsleopard_accountID" name="smsleopard_accountID" value="<?=set_value('smsleopard_accountID', $set_smsleopard['smsleopard_accountID'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('smsleopard_accountID'); ?>
                                                </span>
                                            </div>

                                            <?php
                                                if(form_error('smsleopard_secret'))
                                                    echo "<div class='form-group has-error' >";
                                                else
                                                    echo "<div class='form-group' >";
                                            ?>
                                                <label for="smsleopard_secret" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_secret")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                  <?php if (empty($set_smsleopard)): ?>
                                                    <input type="text" class="form-control" id="smsleopard_secret" name="smsleopard_secret" value="<?=set_value('smsleopard_secret')?>" >
                                                  <?php else: ?>
                                                    <input type="text" class="form-control" id="smsleopard_secret" name="smsleopard_secret" value="<?=set_value('smsleopard_secret', $set_smsleopard['smsleopard_secret'])?>" >
                                                  <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('smsleopard_secret'); ?>
                                                </span>
                                            </div>
                            ...
                            <div id="bongasms" class="tab-pane <?php if($bongasms == 1) echo 'active';?> ">
                                              <br>
                                              <div class="row">
                                                  <div class="col-sm-10">
                                                      <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                                          <?php echo form_hidden('type', 'bongasms'); ?>
              											<?php
                                                              if(form_error('bongasms_senderID'))
                                                                  echo "<div class='form-group has-error' >";
                                                              else
                                                                  echo "<div class='form-group' >";
                                                          ?>
                                                              ...
                                                              <div class="col-sm-6">
                                                                <?php if (empty($set_bongasms)): ?>
                                                                  <input type="text" class="form-control" id="bongasms_senderID" name="bongasms_senderID" value="<?=set_value('bongasms_senderID')?>" >
                                                                <?php else: ?>
                                                                  <input type="text" class="form-control" id="bongasms_senderID" name="bomgasms_senderID" value="<?=set_value('bongasms_senderID', $set_bongasms['bongasms_senderID'])?>" >
                                                                <?php endif; ?>
                                                              </div>
                                                              <span class="col-sm-4 control-label">
                                                                  <?php echo form_error('bongasms_senderID'); ?>
                                                              </span>
                                                          </div>

                                                          <?php
                                                              if(form_error('bongasms_api_clientID'))
                                                                  echo "<div class='form-group has-error' >";
                                                              else
                                                                  echo "<div class='form-group' >";
                                                          ?>
                                                              <label for="bongasms_clientID" class="col-sm-2 control-label">
                                                                  <?=$this->lang->line("smssettings_clientID")?> <span class="text-red">*</span>
                                                              </label>
                                                              <div class="col-sm-6">
                                                                <?php if (empty($set_smsleopard)): ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_clientID" name="bongasms_api_clientID" value="<?=set_value('bongasms_clientID')?>" >
                                                                <?php else: ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_clientID" name="bongasms_api_clientID" value="<?=set_value('bongasms_clientID', $set_bongasms['bongasms_api_clientID'])?>" >
                                                                <?php endif; ?>
                                                              </div>
                                                              <span class="col-sm-4 control-label">
                                                                  <?php echo form_error('bongasms_api_clientID'); ?>
                                                              </span>
                                                          </div>

                                                          <?php
                                                              if(form_error('bongasms_api_key'))
                                                                  echo "<div class='form-group has-error' >";
                                                              else
                                                                  echo "<div class='form-group' >";
                                                          ?>
                                                              <label for="bongasms_key" class="col-sm-2 control-label">
                                                                  <?=$this->lang->line("smssettings_api_key")?> <span class="text-red">*</span>
                                                              </label>
                                                              <div class="col-sm-6">
                                                                <?php if (empty($set_bongasms)): ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_key" name="bongasms_api_key" value="<?=set_value('bongasms_api_key')?>" >
                                                                <?php else: ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_key" name="bongasms_api_key" value="<?=set_value('bongasms_api_key', $set_bongasms['bongasms_api_key'])?>" >
                                                                <?php endif; ?>
                                                              </div>
                                                              <span class="col-sm-4 control-label">
                                                                  <?php echo form_error('bongasms_api_key'); ?>
                                                              </span>
                                                          </div>

                                                          <?php
                                                              if(form_error('bongasms_api_secret'))
                                                                  echo "<div class='form-group has-error' >";
                                                              else
                                                                  echo "<div class='form-group' >";
                                                          ?>
                                                              <label for="bongasms_secret" class="col-sm-2 control-label">
                                                                  <?=$this->lang->line("smssettings_secret")?> <span class="text-red">*</span>
                                                              </label>
                                                              <div class="col-sm-6">
                                                                <?php if (empty($set_bongasms)): ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_secret" name="bongasms_api_secret" value="<?=set_value('bongasms_api_secret')?>" >
                                                                <?php else: ?>
                                                                  <input type="text" class="form-control" id="bongasms_api_secret" name="bongasms_api_secret" value="<?=set_value('bongasms_api_secret', $set_bongasms['bongasms_api_secret'])?>" >
                                                                <?php endif; ?>
                                                              </div>
                                                              <span class="col-sm-4 control-label">
                                                                  <?php echo form_error('bongasms_api_secret'); ?>
                                                              </span>
                                                          </div>
