    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if(permissionChecker('stock_adjust')) { ?>
                    <a href="<?php echo base_url('stock/adjust') ?>">
                        <i class="fa fa-adjust"></i>
                        <?=$this->lang->line('adjust_title')?>
                    </a> &nbsp&nbsp
                <?php } if(permissionChecker('stock_move')) { ?>
                      <a href="<?php echo base_url('stock/move') ?>">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1"><?=$this->lang->line('stock_type')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($mainstocks)) {$i = 1; foreach($mainstocks as $mainstock) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('stock_type')?>">
                                        <?=$mainstock->type;?>
                                    </td>
                                    ...
                                    <td>
                                      <?php if(permissionChecker('stock_view')) {
                                        echo btn_view('stock/view/'.$mainstock->mainstockID, $this->lang->line('view'));
                                      } ?>
                                    </td>
                                </tr>
                            <?php $i++; }} ?>
