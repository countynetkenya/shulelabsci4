        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                $arraytype[2] = $this->lang->line("subject_nonexaminable");
                    ...
                    <?php
                        if(form_error('targetmark'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="targetmark" class="col-sm-2 control-label">
                            <?=$this->lang->line("subject_targetmark")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="targetmark" name="targetmark" value="<?=set_value('targetmark', $subject->targetmark)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('targetmark'); ?>
                        </span>
                    </div>
                    ...
                    <?php
                        if(form_error('report_order'))
                            echo "<div class='form-group has-error' >";
                        else
                            echo "<div class='form-group' >";
                    ?>
                        <label for="report_order" class="col-sm-2 control-label">
                            <?=$this->lang->line("subject_report_order")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="report_order" name="report_order" value="<?=set_value('report_order', $subject->report_order)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('report_order'); ?>
                        </span>
                    </div>
