                    ...
                    <table id="example2" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th><?=$this->lang->line('subject_report_order')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($subjects)) {$i = 1; foreach($subjects as $subject) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('subject_report_order')?>">
                                        <?php echo $subject->report_order; ?>
                                    </td>
                                    ...
                                    <td data-title="<?=$this->lang->line('subject_type')?>">
                                        ...
                                        <?php } elseif($subject->type == 2) { ?>
                                            <button type="button" class="btn btn-secondary btn-xs"><?php echo $this->lang->line('subject_nonexaminable'); ?></button>
                                        <?php } ?>
                                    </td>
