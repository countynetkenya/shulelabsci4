            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="targetmark" name="targetmark" value="<?=set_value('targetmark')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="report_order" name="report_order" value="<?=set_value('report_order', 0)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
