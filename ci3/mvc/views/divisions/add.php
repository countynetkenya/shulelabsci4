...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_divisions')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="divisions" name="divisions" value="<?=set_value('divisions')?>" >
                        </div>
                    ...
                    <?php
                        if(form_error('quickbooksclass'))
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="quickbooksclass" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            ...
                            ?>
                            <?php
                                echo form_dropdown("quickbooksclass", $quickbooksclassArray, set_value("quickbooksclass"), "id='quickbooksclass' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                  ...
                  <?php } elseif (now() > $config['sessionAccessTokenExpiry']) {?>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-8">
                        <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_division")?>" >
                      </div>
                    </div>
