...
class Daraja
{
    ...
    public function lipaNaMpesaOnline($transactionDetails)
    {
        ...
        $paymentRequest = [
            ...
            'PartyB' => $transactionDetails['PartyB'],
    ...
    {
      $url = 'https://'. $this->demo .'.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';
      ...
      $array = json_decode($curl_response, TRUE);
        ...
        $url = 'https://'. $this->demo .'.safaricom.co.ke/mpesa/stkpush/v1/processrequest';
    ...
    {
        $url = 'https://'. $this->demo .'.safaricom.co.ke/safaricom/identity/v1/checkidentity';
    ...
    private function password() {
      return base64_encode($this->lipaNaMpesaOnlineShortcode.$this->lipaNaMpesaOnlinePasskey.$this->time());
    }
}
