...
|:-------|:---------|:------------|:-------|
| **Classes** |
| GET | `/api/v1/academics/classes` | List classes | Staff |
| POST | `/api/v1/academics/classes` | Create class | Admin |
| GET | `/api/v1/academics/classes/{id}/students` | Get class students | Staff |
| GET | `/api/v1/academics/classes/{id}/timetable` | Get class timetable | All |
| **Subjects** |
| GET | `/api/v1/academics/subjects` | List subjects | Staff |
| POST | `/api/v1/academics/subjects` | Create subject | Admin |
| **Timetable** |
| GET | `/api/v1/academics/timetable` | Get current user's timetable | All |
| POST | `/api/v1/academics/timetable/generate` | Auto-generate timetable | Admin |
| PUT | `/api/v1/academics/timetable/entries/{id}` | Update entry | Admin |
| **Attendance** |
| GET | `/api/v1/academics/attendance/class/{id}` | Get class attendance | Teacher |
| POST | `/api/v1/academics/attendance` | Mark attendance | Teacher |
| GET | `/api/v1/academics/attendance/student/{id}` | Get student attendance | Student/Parent |
| **Gradebook** |
| GET | `/api/v1/academics/assessments` | List assessments | Teacher |
| POST | `/api/v1/academics/assessments` | Create assessment | Teacher |
| POST | `/api/v1/academics/assessments/{id}/grades` | Enter grades | Teacher |
| GET | `/api/v1/academics/grades/student/{id}` | Get student grades | Student/Parent |
| **Report Cards** |
| GET | `/api/v1/academics/report-cards` | List report cards | Staff |
| POST | `/api/v1/academics/report-cards/generate` | Generate report cards | Admin |
| GET | `/api/v1/academics/report-cards/{id}` | View report card | Student/Parent |
| POST | `/api/v1/academics/report-cards/{id}/approve` | Approve report card | Admin |
...
│   └── Web/
│       └── AcademicsDashboardController.php
├── Models/
...
├── Database/
│   └── Migrations/
│       └── 2025-11-27-000001_CreateAcademicsTables.php
├── Views/
│   ├── dashboard/
│   ├── classes/
│   ├── timetable/
...
Use `Modules\Academics\Database\Seeds\AcademicsSeeder`:
