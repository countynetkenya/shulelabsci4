...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-plus-circle text-success"></i> Add Scheduled Job
        </h1>
            ...
            <form action="<?= site_url('scheduler/store') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>" 
                              ...
                              placeholder="Brief description of what this job does"><?= old('description') ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.job_class') ? 'is-invalid' : '' ?>" 
                                   id="job_class" name="job_class" value="<?= old('job_class') ?>" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.job_method') ? 'is-invalid' : '' ?>" 
                                   id="job_method" name="job_method" value="<?= old('job_method', 'handle') ?>" 
                                   placeholder="handle">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.cron_expression') ? 'is-invalid' : '' ?>" 
                                   id="cron_expression" name="cron_expression" value="<?= old('cron_expression') ?>" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= session('errors.timezone') ? 'is-invalid' : '' ?>" 
                                   id="timezone" name="timezone" value="<?= old('timezone', 'Africa/Nairobi') ?>" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" 
                                   id="retry_delay_seconds" name="retry_delay_seconds" value="<?= old('retry_delay_seconds', 60) ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" 
                                   id="timeout_seconds" name="timeout_seconds" value="<?= old('timeout_seconds', 3600) ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= session('errors.parameters') ? 'is-invalid' : '' ?>" 
                              ...
                              placeholder='{"key": "value"}'><?= old('parameters') ?></textarea>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="overlap_prevention" name="overlap_prevention" value="1" <?= old('overlap_prevention', '1') == '1' ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Save Scheduled Job
                    </button>
                    <a href="<?= site_url('scheduler') ?>" class="btn btn-secondary">
