...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-graduate text-primary"></i> Edit Student
        </h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="admission_number" name="admission_number" value="<?= old('admission_number', $student['admission_number']) ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
