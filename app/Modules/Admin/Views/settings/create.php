...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-cog text-primary"></i> Add New Setting
        </h1>
            ...
            <form action="<?= site_url('admin/settings/store') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" 
                              ...
                              name="value" 
                              rows="3"
                              placeholder="Setting value..."><?= old('value') ?></textarea>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="context" name="context">
                            <option value="app" <?= old('context') === 'app' ? 'selected' : '' ?>>App</option>
                            <option value="user" <?= old('context') === 'user' ? 'selected' : '' ?>>User</option>
                            <option value="system" <?= old('context') === 'system' ? 'selected' : '' ?>>System</option>
                        </select>
