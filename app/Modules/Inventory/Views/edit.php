                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                <option value="physical" <?= old('type', $item->type) == 'physical' ? 'selected' : '' ?>>Physical</option>
                                <option value="service" <?= old('type', $item->type) == 'service' ? 'selected' : '' ?>>Service</option>
                                <option value="bundle" <?= old('type', $item->type) == 'bundle' ? 'selected' : '' ?>>Bundle</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="unit_cost" class="form-control" value="<?= old('unit_cost', $item->unit_cost) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
