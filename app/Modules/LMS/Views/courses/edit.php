...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('lms/courses/update/' . $course['id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="modules" name="modules" rows="3"><?= old('modules', $course['modules']) ?></textarea>
