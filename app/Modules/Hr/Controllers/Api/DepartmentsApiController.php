...
use Modules\Hr\Services\DepartmentsService;

/**
 * DepartmentsApiController
 * 
 * RESTful API controller for departments
 ...
 */
class DepartmentsApiController extends ResourceController
{
    protected $modelName = '';
    protected $format = 'json';
    protected DepartmentsService $service;
