...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="<?= site_url('hr/employees/create') ?>" method="post">
                <?= csrf_field() ?>

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="user_id">User ID (Temporary)</label>
                            <input type="number" class="form-control" id="user_id" name="user_id" value="<?= old('user_id') ?>" required>
                            <small class="form-text text-muted">In a real scenario, this would be a user search/select.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="designation_id" name="designation_id" value="<?= old('designation_id') ?>">
                        </div>
                    </div>
                </div>
