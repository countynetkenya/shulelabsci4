...
<div class="max-w-2xl mx-auto">
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Edit Employee Details</h2>
        </div>
    ...
    <form action="<?= site_url('hr/employees/update/' . $employee['id']) ?>" method="post" class="space-y-8 divide-y divide-gray-200 bg-white p-6 shadow rounded-lg">
        <?= csrf_field() ?>
            ...
            <div>
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" name="user_id" id="user_id" value="<?= old('user_id', $employee['user_id']) ?>" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="text" name="employee_number" id="employee_number" value="<?= old('employee_number', $employee['employee_number']) ?>" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" name="department_id" id="department_id" value="<?= old('department_id', $employee['department_id']) ?>" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" name="designation_id" id="designation_id" value="<?= old('designation_id', $employee['designation_id']) ?>" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="date" name="join_date" id="join_date" value="<?= old('join_date', $employee['join_date']) ?>" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" step="0.01" name="basic_salary" id="basic_salary" value="<?= old('basic_salary', $employee['basic_salary']) ?>" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="pt-5">
            <div class="flex justify-end">
                ...
                <button type="submit" class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Update Employee</button>
            </div>
        </div>
    </form>
</div>
