...
use Modules\Finance\Services\FeesService;

/**
 * FeesApiController
 * 
 * RESTful API controller for fees
 ...
 */
class FeesApiController extends ResourceController
{
    protected $modelName = '';
    protected $format = 'json';
    protected FeesService $service;

    public function __construct()
    {
        $this->service = new FeesService();
    }
