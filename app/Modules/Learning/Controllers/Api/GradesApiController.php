...
use Modules\Learning\Services\GradesService;

/**
 * GradesApiController
 * 
 * RESTful API controller for grades
 ...
 */
class GradesApiController extends ResourceController
{
    protected $modelName = '';
    protected $format = 'json';
    protected GradesService $service;
