...
use Modules\Learning\Services\SubjectsService;

/**
 * SubjectsApiController
 * 
 * RESTful API controller for subjects
 * Generated by Master Orchestration Agent
 * 
 * @package Modules\Learning\Controllers\Api
 * @version 1.0.0
 * @generated 2025-11-22
 */
class SubjectsApiController extends ResourceController
{
    protected $modelName = '';
    protected $format = 'json';
    protected SubjectsService $service;
