...
use Modules\Library\Services\BorrowingService;

/**
 * BorrowingApiController
 * 
 * RESTful API controller for borrowing
 ...
 */
class BorrowingApiController extends ResourceController
{
    protected $modelName = '';
