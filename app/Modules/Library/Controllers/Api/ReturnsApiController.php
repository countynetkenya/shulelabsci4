...
use Modules\Library\Services\ReturnsService;

/**
 * ReturnsApiController
 * 
 * RESTful API controller for returns
 * Generated by Master Orchestration Agent
 * 
 * @package Modules\Library\Controllers\Api
 * @version 1.0.0
 * @generated 2025-11-22
 */
class ReturnsApiController extends ResourceController
{
    protected $modelName = '';
    protected $format = 'json';
    protected ReturnsService $service;
